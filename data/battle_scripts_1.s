...
BattleScript_EffectFling::
	...
	jumpiflastuseditemholdeffect BS_ATTACKER, HOLD_EFFECT_ICY_BALL, BattleScript_FlingFrostOrb
	jumpiflastuseditemholdeffect BS_ATTACKER, HOLD_EFFECT_MENTAL_HERB, BattleScript_FlingMentalHerb
	jumpiflastuseditemholdeffect BS_ATTACKER, HOLD_EFFECT_MIASMA_POWER, BattleScript_FlingPoisonBarb
...
BattleScript_EffectSleep::
	...
	jumpifability BS_TARGET, ABILITY_LIFESTREAM, BattleScript_AbilityProtectsDoesntAffect
...
BattleScript_EffectSubZero::
	attackcanceler
	attackstring
	ppreduce
	jumpifsubstituteblocks BattleScript_ButItFailed
	jumpifstatus BS_TARGET, STATUS1_FROSTBITE, BattleScript_AlreadyFrostbit
	jumpiftype BS_TARGET, TYPE_FIRE, BattleScript_NotAffected
	jumpifability BS_TARGET, ABILITY_FIRE_VEIL, BattleScript_FireVeilPrevents
	jumpifability BS_TARGET, ABILITY_FLAME_BODY, BattleScript_FireVeilPrevents
	jumpifability BS_TARGET, ABILITY_COMATOSE, BattleScript_AbilityProtectsDoesntAffect
	jumpifability BS_TARGET, ABILITY_LIFESTREAM, BattleScript_AbilityProtectsDoesntAffect
	jumpifflowerveil BattleScript_FlowerVeilProtects
	jumpifleafguardprotected BS_TARGET, BattleScript_AbilityProtectsDoesntAffect
...
BattleScript_EffectYawn::
	...
	jumpifability BS_TARGET, ABILITY_LIFESTREAM, BattleScript_PrintBattlerAbilityMadeIneffective
	jumpifflowerveil BattleScript_FlowerVeilProtects
	jumpifleafguardprotected BS_TARGET, BattleScript_AbilityProtectsDoesntAffect
	jumpifshieldsdown BS_TARGET, BattleScript_AbilityProtectsDoesntAffect
	jumpifsleepclause BattleScript_SleepClauseBlocked
...
BattleScript_LocalBattleLost::
	...
	@ jumpifbattletype BATTLE_TYPE_INGAME_PARTNER, BattleScript_EReaderOrSecretBaseTrainerEnd
...
BattleScript_GulpMissileGulping::
	...
	jumpifability BS_ATTACKER, ABILITY_HAKUREI_MIKO, BattleScript_GulpMissileNoSecondEffectGulping
	jumpifability BS_ATTACKER, ABILITY_FULL_METAL_BODY, BattleScript_GulpMissileNoSecondEffectGulping
	jumpifability BS_ATTACKER, ABILITY_MAGIC_BARRIER, BattleScript_GulpMissileNoSecondEffectGulping
...
BattleScript_FascinateContrary:
	call BattleScript_AbilityPopUpTarget
	jumpifbyte CMP_EQUAL, cMULTISTRING_CHOOSER, B_MSG_STAT_WONT_INCREASE, BattleScript_FascinateContrary_WontIncrease
	playanimation BS_TARGET, B_ANIM_STATS_CHANGE, sB_ANIM_ARG1
	printfromtable gStatUpStringIds
	goto BattleScript_FascinateEffect_WaitString
