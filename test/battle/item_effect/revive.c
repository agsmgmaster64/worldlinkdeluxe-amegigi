...
DOUBLE_BATTLE_TEST("Revive works for a partner in a double battle")
{
    GIVEN {
        ...
        OPPONENT(SPECIES_ABRA) { Speed(3); Moves(MOVE_TACKLE, MOVE_MANA_BURST, MOVE_CELEBRATE); }
        OPPONENT(SPECIES_KADABRA) { Speed(2); Moves(MOVE_TACKLE, MOVE_MANA_BURST, MOVE_CELEBRATE, MOVE_EXPLOSION); }
    } WHEN {
