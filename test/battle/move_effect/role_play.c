...
SINGLE_BATTLE_TEST("Role Play fails if target has a banned ability")
{
    ...
    PARAMETRIZE { species = SPECIES_NORMAL_BENBEN; ability = ABILITY_WONDER_GUARD; }
    PARAMETRIZE { species = SPECIES_CHIBI_KASEN; ability = ABILITY_FORECAST; }
    PARAMETRIZE { species = SPECIES_CHIBI_MARGATROID; ability = ABILITY_FLOWER_GIFT; }
    ...
    PARAMETRIZE { species = SPECIES_NORMAL_KEINE; ability = ABILITY_NEUTRALIZING_GAS; }
