...
static bool8 FindMonThatAbsorbsOpponentsMove(u32 battler)
{
    ...
    else if (gBattleMoves[gLastLandedMoves[battler]].type == TYPE_WIND)
    {
    ...
    else if (gBattleMoves[gLastLandedMoves[battler]].type == TYPE_NATURE)
    {
        absorbingTypeAbilities[0] = ABILITY_SAP_SIPPER;
        absorbingTypeAbilities[0] = ABILITY_FLORA_ABSORB;
