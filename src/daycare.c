...
static u16 DetermineEggSpeciesAndParentSlots(struct DayCare *daycare, u8 *parentSlots)
{
    ...
    if (eggSpecies == SPECIES_HOURAI && daycare->offspringPersonality & EGG_GENDER_MALE)
        eggSpecies = SPECIES_SHANGHAI;
    else if (eggSpecies == SPECIES_SHANGHAI && !(daycare->offspringPersonality & EGG_GENDER_MALE))
