...
const u8 *const gMonIconTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_CHIBI_REIMU] = gMonIcon_Bulbasaur,
    [SPECIES_NORMAL_REIMU] = gMonIcon_Ivysaur,
    [SPECIES_ATTACK_REIMU] = gMonIcon_Venusaur,
    [SPECIES_DEFENSE_REIMU] = gMonIcon_Charmander,
    [SPECIES_CHIBI_MARISA] = gMonIcon_Charmeleon,
    [SPECIES_NORMAL_MARISA] = gMonIcon_Charizard,
    [SPECIES_ATTACK_MARISA] = gMonIcon_Squirtle,
    [SPECIES_SPEED_MARISA] = gMonIcon_Wartortle,
    [SPECIES_CHIBI_DAIYOUSEI] = gMonIcon_Blastoise,
    [SPECIES_NORMAL_DAIYOUSEI] = gMonIcon_Caterpie,
    [SPECIES_ATTACK_DAIYOUSEI] = gMonIcon_Metapod,
    [SPECIES_DEFENSE_DAIYOUSEI] = gMonIcon_Butterfree,
    [SPECIES_CHIBI_CIRNO] = gMonIcon_Weedle,
    [SPECIES_NORMAL_CIRNO] = gMonIcon_Kakuna,
    [SPECIES_SPEED_CIRNO] = gMonIcon_Beedrill,
    [SPECIES_TECH_CIRNO] = gMonIcon_Pidgey,
    [SPECIES_CHIBI_RUMIA] = gMonIcon_Pidgeotto,
    [SPECIES_NORMAL_RUMIA] = gMonIcon_Pidgeot,
    [SPECIES_ATTACK_RUMIA] = gMonIcon_Rattata,
    [SPECIES_SPEED_RUMIA] = gMonIcon_Raticate,
    [SPECIES_CHIBI_MEILING] = gMonIcon_Spearow,
    [SPECIES_NORMAL_MEILING] = gMonIcon_Fearow,
    [SPECIES_DEFENSE_MEILING] = gMonIcon_Ekans,
    [SPECIES_SPEED_MEILING] = gMonIcon_Arbok,
    [SPECIES_CHIBI_KOAKUMA] = gMonIcon_Pikachu,
    [SPECIES_NORMAL_KOAKUMA] = gMonIcon_Raichu,
    [SPECIES_HELPER_KOAKUMA] = gMonIcon_Sandshrew,
    [SPECIES_PLCEHOLDER1_KOAKUMA] = gMonIcon_Sandslash,
    [SPECIES_CHIBI_PATCHOULI] = gMonIcon_NidoranF,
    [SPECIES_NORMAL_PATCHOULI] = gMonIcon_Nidorina,
    [SPECIES_ATTACK_PATCHOULI] = gMonIcon_Nidoqueen,
    [SPECIES_DEFENSE_PATCHOULI] = gMonIcon_NidoranM,
    ...
    [SPECIES_CHIBI_YOUMU] = gMonIcon_THYoumu1,
    [SPECIES_NORMAL_YOUMU] = gMonIcon_THYoumu2N,
    [SPECIES_DEFENSE_YOUMU] = gMonIcon_THYoumu2D,
    [SPECIES_SPEED_YOUMU] = gMonIcon_THYoumu2S,
    ...
    [SPECIES_CHIBI_REISEN] = gMonIcon_Seadra,
    [SPECIES_NORMAL_REISEN] = gMonIcon_Goldeen,
    [SPECIES_DEFENSE_REISEN] = gMonIcon_Seaking,
    [SPECIES_TECH_REISEN] = gMonIcon_Staryu,
...
const u8 *const gMonIconTableFemale[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_CHIBI_KOAKUMA] = gMonIcon_PikachuF,
...
{
    [SPECIES_CHIBI_REIMU] = 4,
    [SPECIES_NORMAL_REIMU] = 4,
    [SPECIES_ATTACK_REIMU] = 4,
    [SPECIES_DEFENSE_REIMU] = 0,
    [SPECIES_CHIBI_MARISA] = 0,
    [SPECIES_NORMAL_MARISA] = 0,
    [SPECIES_ATTACK_MARISA] = 0,
    [SPECIES_SPEED_MARISA] = 2,
    [SPECIES_CHIBI_DAIYOUSEI] = 2,
    [SPECIES_NORMAL_DAIYOUSEI] = 1,
    [SPECIES_ATTACK_DAIYOUSEI] = 1,
    [SPECIES_DEFENSE_DAIYOUSEI] = 0,
    [SPECIES_CHIBI_CIRNO] = 2,
    [SPECIES_NORMAL_CIRNO] = 2,
    [SPECIES_SPEED_CIRNO] = 2,
    [SPECIES_TECH_CIRNO] = 0,
    [SPECIES_CHIBI_RUMIA] = 0,
    [SPECIES_NORMAL_RUMIA] = 0,
    [SPECIES_ATTACK_RUMIA] = 2,
    [SPECIES_SPEED_RUMIA] = 2,
    [SPECIES_CHIBI_MEILING] = 0,
    [SPECIES_NORMAL_MEILING] = 0,
    [SPECIES_DEFENSE_MEILING] = 2,
    [SPECIES_SPEED_MEILING] = 2,
    [SPECIES_CHIBI_KOAKUMA] = 2,
    [SPECIES_NORMAL_KOAKUMA] = 0,
    [SPECIES_HELPER_KOAKUMA] = 2,
    [SPECIES_PLCEHOLDER1_KOAKUMA] = 2,
    [SPECIES_CHIBI_PATCHOULI] = 0,
    [SPECIES_NORMAL_PATCHOULI] = 0,
    ...
    [SPECIES_RAPIDASH] = 3,
    [SPECIES_SLOWPOKE] = 0,
    [SPECIES_CHIBI_YOUMU] = 3,
    [SPECIES_NORMAL_YOUMU] = 3,
    [SPECIES_DEFENSE_YOUMU] = 3,
    [SPECIES_SPEED_YOUMU] = 3,
    [SPECIES_DODUO] = 2,
    [SPECIES_DODRIO] = 2,
    [SPECIES_SEEL] = 0,
    [SPECIES_DEWGONG] = 2,
    ...
    [SPECIES_NORMAL_REISEN] = 0,
    [SPECIES_DEFENSE_REISEN] = 0,
    [SPECIES_TECH_REISEN] = 2,
    [SPECIES_STARMIE] = 2,
    [SPECIES_MR_MIME] = 0,
    [SPECIES_SCYTHER] = 1,
    [SPECIES_JYNX] = 2,
