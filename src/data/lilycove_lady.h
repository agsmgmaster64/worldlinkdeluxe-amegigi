...
{
    [CONTEST_CATEGORY_COOL]   = SPECIES_CHIBI_TOJIKO,
    [CONTEST_CATEGORY_BEAUTY] = SPECIES_NORMAL_RAIKO,
    [CONTEST_CATEGORY_CUTE]   = SPECIES_SPEED_SEIGA,
    [CONTEST_CATEGORY_SMART]  = SPECIES_NORMAL_KASEN,
    [CONTEST_CATEGORY_TOUGH]  = SPECIES_CHIBI_KOAKUMA
};
