...
static const struct FormChange sRotomFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_PLACEHOLD_MITORI,       ITEM_ROTOM_CATALOG, 0},
...
static const struct FormChange sDarmanitanFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_CHIBI_NARUMI, ABILITY_ZEN_MODE, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_DARMANITAN_ZEN,      ABILITY_ZEN_MODE, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_FAINT,             SPECIES_CHIBI_NARUMI},
    {FORM_CHANGE_END_BATTLE,        SPECIES_CHIBI_NARUMI},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct Fusion sCalyrexFusionTable[] = {
    {3, ITEM_REINS_OF_UNITY, SPECIES_CALYREX,  SPECIES_GLASTRIER, SPECIES_CALYREX_ICE,    MOVE_GLACIAL_BASH,   MOVE_PSYSHOT},
    {3, ITEM_REINS_OF_UNITY, SPECIES_CALYREX,  SPECIES_SPECTRIER, SPECIES_CALYREX_SHADOW, MOVE_ASTRAL_BARRAGE,  MOVE_PSYSHOT},
    {FUSION_TERMINATOR},
};
...
#if P_TERA_FORMS
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_TEAL_TERA,        TYPE_NATURE},
