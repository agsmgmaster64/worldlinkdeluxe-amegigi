...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CHIBI_KASEN, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW), ABILITY_FORECAST},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CHIBI_KASEN, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW)},
    {FORM_CHANGE_BATTLE_WEATHER,                SPECIES_CHIBI_KASEN, B_WEATHER_NONE},
#endif
    {FORM_CHANGE_BATTLE_SWITCH,                 SPECIES_CHIBI_KASEN},
    {FORM_CHANGE_FAINT,                         SPECIES_CHIBI_KASEN},
    {FORM_CHANGE_END_BATTLE,                    SPECIES_CHIBI_KASEN},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sDeoxysSpeedFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_NORMAL_RIKAKO,  ITEM_METEORITE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sBurmyFormChangeTable[] = {
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_CHIBI_GENGETSU, BATTLE_TERRAIN_GRASS},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_CHIBI_GENGETSU, BATTLE_TERRAIN_LONG_GRASS},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_CHIBI_GENGETSU, BATTLE_TERRAIN_POND},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_CHIBI_GENGETSU, BATTLE_TERRAIN_MOUNTAIN},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_CHIBI_GENGETSU, BATTLE_TERRAIN_PLAIN},
...
#endif
    {FORM_CHANGE_BATTLE_SWITCH,                 SPECIES_CHIBI_MARGATROID},
    {FORM_CHANGE_FAINT,                         SPECIES_CHIBI_MARGATROID},
    {FORM_CHANGE_END_BATTLE,                    SPECIES_CHIBI_MARGATROID},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sDialgaFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ADVENT_CIRNO, ITEM_NONE},
...
static const struct FormChange sPalkiaFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ADVENT_REISEN, ITEM_NONE},
...
static const struct FormChange sGiratinaFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ADVENT_LETTY, ITEM_NONE},
...
static const struct Fusion sNecrozmaFusionTable[] = {
    {1, ITEM_N_SOLARIZER,    SPECIES_NECROZMA, SPECIES_SOLGALEO,  SPECIES_NECROZMA_DUSK_MANE,   MOVE_SUNSTEEL_STRIKE, MOVE_PSYSHOT},
    {2, ITEM_N_LUNARIZER,    SPECIES_NECROZMA, SPECIES_LUNALA,    SPECIES_NECROZMA_DAWN_WINGS,  MOVE_MOONGEIST_BEAM,  MOVE_PSYSHOT},
    {FUSION_TERMINATOR},
};
...
static const struct FormChange sZacianFormChangeTable[] = {
    ...
    {FORM_CHANGE_END_BATTLE,   SPECIES_ZACIAN_HERO_OF_MANY_BATTLES, ITEM_RUSTED_SWORD, MOVE_BEHEMOTH_BLADE, MOVE_DRAWN_LINE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sZamazentaFormChangeTable[] = {
    ...
    {FORM_CHANGE_END_BATTLE,   SPECIES_ZAMAZENTA_HERO_OF_MANY_BATTLES, ITEM_RUSTED_SHIELD, MOVE_BEHEMOTH_BASH,  MOVE_DRAWN_LINE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct Fusion sCalyrexFusionTable[] = {
    {3, ITEM_REINS_OF_UNITY, SPECIES_CALYREX,  SPECIES_GLASTRIER, SPECIES_CALYREX_ICE_RIDER,    MOVE_GLACIAL_LANCE,   MOVE_PSYSHOT},
    {3, ITEM_REINS_OF_UNITY, SPECIES_CALYREX,  SPECIES_SPECTRIER, SPECIES_CALYREX_SHADOW_RIDER, MOVE_ASTRAL_BARRAGE,  MOVE_PSYSHOT},
    {FUSION_TERMINATOR},
};
...
static const struct FormChange sOgerponFormChangeTable[] = {
...
#if P_TERA_FORMS
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_TEAL_MASK_TERA,        TYPE_NATURE},
    ...
    {FORM_CHANGE_BATTLE_TERASTALLIZATION, SPECIES_OGERPON_CORNERSTONE_MASK_TERA, TYPE_BEAST},
#endif
    {FORM_CHANGE_TERMINATOR},
};
