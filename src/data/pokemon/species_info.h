...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_COSMIC : TYPE_REASON)
    ...
    [SPECIES_RALTS] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 35,
        .types = { TYPE_REASON, RALTS_FAMILY_TYPE2 },
        .catchRate = 235,
        .expYield = 40,
        .evYield_SpAttack  = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define ARCEUS_SPECIES_INFO(type)                                       \
    ...
    [SPECIES_ARCEUS_NORMAL]   = ARCEUS_SPECIES_INFO(TYPE_ILLUSION),
...
#define VIVILLON_SPECIES_INFO(color)                                                    \
    ...
    [SPECIES_VIVILLON_ICY_SNOW]    = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_POLAR]       = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_TUNDRA]      = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    ...
    [SPECIES_VIVILLON_MODERN]      = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_MARINE]      = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_ARCHIPELAGO] = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_HIGH_PLAINS] = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_SANDSTORM]   = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_RIVER]       = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_MONSOON]     = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_SAVANNA]     = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_SUN]         = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_OCEAN]       = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_JUNGLE]      = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_FANCY]       = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_VIVILLON_POKE_BALL]   = VIVILLON_SPECIES_INFO(SOURCE_OTHER),
...
#define MINIOR_CORE_SPECIES_INFO(color) \
    ...
    [SPECIES_MINIOR_CORE_RED]      = MINIOR_CORE_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_MINIOR_CORE_ORANGE]   = MINIOR_CORE_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_MINIOR_CORE_YELLOW]   = MINIOR_CORE_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_MINIOR_CORE_GREEN]    = MINIOR_CORE_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_MINIOR_CORE_BLUE]     = MINIOR_CORE_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_MINIOR_CORE_INDIGO]   = MINIOR_CORE_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_MINIOR_CORE_VIOLET]   = MINIOR_CORE_SPECIES_INFO(SOURCE_OTHER),
...
#define MAGEARNA_SPECIES_INFO(color)                                    \
    ...
    [SPECIES_MAGEARNA]                = MAGEARNA_SPECIES_INFO(SOURCE_OTHER),
    [SPECIES_MAGEARNA_ORIGINAL_COLOR] = MAGEARNA_SPECIES_INFO(SOURCE_OTHER),
...
#define ALCREMIE_REGULAR_MISC_INFO(color, sweet, cream)                     \
    ...
    [SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM] = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Strawberry, VanillaCream), },
    ...
    [SPECIES_ALCREMIE_STRAWBERRY_MINT_CREAM]    = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Strawberry, MintCream), },
    [SPECIES_ALCREMIE_STRAWBERRY_LEMON_CREAM]   = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Strawberry, LemonCream), },
    [SPECIES_ALCREMIE_STRAWBERRY_SALTED_CREAM]  = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Strawberry, SaltedCream), },
    [SPECIES_ALCREMIE_STRAWBERRY_RUBY_SWIRL]    = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Strawberry, RubySwirl), },
    [SPECIES_ALCREMIE_STRAWBERRY_CARAMEL_SWIRL] = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Strawberry, CaramelSwirl), },
    [SPECIES_ALCREMIE_STRAWBERRY_RAINBOW_SWIRL] = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Strawberry, RainbowSwirl), },
    [SPECIES_ALCREMIE_BERRY_VANILLA_CREAM]      = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Berry, VanillaCream) },
    ...
    [SPECIES_ALCREMIE_BERRY_MINT_CREAM]         = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Berry, MintCream), },
    [SPECIES_ALCREMIE_BERRY_LEMON_CREAM]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Berry, LemonCream), },
    [SPECIES_ALCREMIE_BERRY_SALTED_CREAM]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Berry, SaltedCream), },
    [SPECIES_ALCREMIE_BERRY_RUBY_SWIRL]         = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Berry, RubySwirl), },
    [SPECIES_ALCREMIE_BERRY_CARAMEL_SWIRL]      = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Berry, CaramelSwirl), },
    [SPECIES_ALCREMIE_BERRY_RAINBOW_SWIRL]      = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Berry, RainbowSwirl), },
    [SPECIES_ALCREMIE_LOVE_VANILLA_CREAM]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Love, VanillaCream) },
    ...
    [SPECIES_ALCREMIE_LOVE_MINT_CREAM]          = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Love, MintCream), },
    [SPECIES_ALCREMIE_LOVE_LEMON_CREAM]         = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Love, LemonCream), },
    [SPECIES_ALCREMIE_LOVE_SALTED_CREAM]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Love, SaltedCream), },
    [SPECIES_ALCREMIE_LOVE_RUBY_SWIRL]          = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Love, RubySwirl), },
    [SPECIES_ALCREMIE_LOVE_CARAMEL_SWIRL]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Love, CaramelSwirl), },
    [SPECIES_ALCREMIE_LOVE_RAINBOW_SWIRL]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Love, RainbowSwirl), },
    [SPECIES_ALCREMIE_STAR_VANILLA_CREAM]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Star, VanillaCream) },
    ...
    [SPECIES_ALCREMIE_STAR_MINT_CREAM]          = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Star, MintCream), },
    [SPECIES_ALCREMIE_STAR_LEMON_CREAM]         = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Star, LemonCream), },
    [SPECIES_ALCREMIE_STAR_SALTED_CREAM]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Star, SaltedCream), },
    [SPECIES_ALCREMIE_STAR_RUBY_SWIRL]          = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Star, RubySwirl), },
    [SPECIES_ALCREMIE_STAR_CARAMEL_SWIRL]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Star, CaramelSwirl), },
    [SPECIES_ALCREMIE_STAR_RAINBOW_SWIRL]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Star, RainbowSwirl), },
    [SPECIES_ALCREMIE_CLOVER_VANILLA_CREAM]     = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Clover, VanillaCream) },
    ...
    [SPECIES_ALCREMIE_CLOVER_MINT_CREAM]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Clover, MintCream), },
    [SPECIES_ALCREMIE_CLOVER_LEMON_CREAM]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Clover, LemonCream), },
    [SPECIES_ALCREMIE_CLOVER_SALTED_CREAM]      = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Clover, SaltedCream), },
    [SPECIES_ALCREMIE_CLOVER_RUBY_SWIRL]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Clover, RubySwirl), },
    [SPECIES_ALCREMIE_CLOVER_CARAMEL_SWIRL]     = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Clover, CaramelSwirl), },
    [SPECIES_ALCREMIE_CLOVER_RAINBOW_SWIRL]     = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Clover, RainbowSwirl), },
    [SPECIES_ALCREMIE_FLOWER_VANILLA_CREAM]     = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Flower, VanillaCream) },
    ...
    [SPECIES_ALCREMIE_FLOWER_MINT_CREAM]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Flower, MintCream), },
    [SPECIES_ALCREMIE_FLOWER_LEMON_CREAM]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Flower, LemonCream), },
    [SPECIES_ALCREMIE_FLOWER_SALTED_CREAM]      = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Flower, SaltedCream), },
    [SPECIES_ALCREMIE_FLOWER_RUBY_SWIRL]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Flower, RubySwirl), },
    [SPECIES_ALCREMIE_FLOWER_CARAMEL_SWIRL]     = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Flower, CaramelSwirl), },
    [SPECIES_ALCREMIE_FLOWER_RAINBOW_SWIRL]     = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Flower, RainbowSwirl), },
    [SPECIES_ALCREMIE_RIBBON_VANILLA_CREAM]     = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Ribbon, VanillaCream) },
    ...
    [SPECIES_ALCREMIE_RIBBON_MINT_CREAM]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Ribbon, MintCream), },
    [SPECIES_ALCREMIE_RIBBON_LEMON_CREAM]       = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Ribbon, LemonCream), },
    [SPECIES_ALCREMIE_RIBBON_SALTED_CREAM]      = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Ribbon, SaltedCream), },
    [SPECIES_ALCREMIE_RIBBON_RUBY_SWIRL]        = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Ribbon, RubySwirl), },
    [SPECIES_ALCREMIE_RIBBON_CARAMEL_SWIRL]     = { ALCREMIE_REGULAR_MISC_INFO(SOURCE_OTHER, Ribbon, CaramelSwirl), },
...
#define PALAFIN_MISC_INFO                                   \
    ...
    [SPECIES_CYCLIZAR] =
    {
        ...
        .baseSpAttack  = 85,
        .baseSpDefense = 65,
        .types = { TYPE_FAITH, TYPE_ILLUSION },
        .catchRate = 190,
        .expYield = 175,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
...
#define OGERPON_SPECIES_INFO(type, ability, color)                      \
    ...
    [SPECIES_OGERPON_TEAL_MASK]              = OGERPON_SPECIES_INFO(TYPE_NATURE, ABILITY_DEFIANT,                   SOURCE_OTHER),
    [SPECIES_OGERPON_WELLSPRING_MASK]        = OGERPON_SPECIES_INFO(TYPE_WATER, ABILITY_WATER_ABSORB,              SOURCE_OTHER),
    [SPECIES_OGERPON_HEARTHFLAME_MASK]       = OGERPON_SPECIES_INFO(TYPE_FIRE,  ABILITY_MOLD_BREAKER,              SOURCE_OTHER),
    [SPECIES_OGERPON_CORNERSTONE_MASK]       = OGERPON_SPECIES_INFO(TYPE_BEAST,  ABILITY_STURDY,                    SOURCE_OTHER),
    [SPECIES_OGERPON_TEAL_MASK_TERA]         = OGERPON_SPECIES_INFO(TYPE_NATURE, ABILITY_EMBODY_ASPECT_TEAL,        SOURCE_OTHER),
    [SPECIES_OGERPON_WELLSPRING_MASK_TERA]   = OGERPON_SPECIES_INFO(TYPE_WATER, ABILITY_EMBODY_ASPECT_WELLSPRING,  SOURCE_OTHER),
    [SPECIES_OGERPON_HEARTHFLAME_MASK_TERA]  = OGERPON_SPECIES_INFO(TYPE_FIRE,  ABILITY_EMBODY_ASPECT_HEARTHFLAME, SOURCE_OTHER),
    [SPECIES_OGERPON_CORNERSTONE_MASK_TERA]  = OGERPON_SPECIES_INFO(TYPE_BEAST,  ABILITY_EMBODY_ASPECT_CORNERSTONE, SOURCE_OTHER),
