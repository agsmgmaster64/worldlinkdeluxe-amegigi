...
#define DECIDUEYE_MISC_INFO                                     \
    ...
    [SPECIES_CHARJABUG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_VIKAVOLT},
                                {EVO_ITEM, ITEM_SWIFT_HEART, SPECIES_VIKAVOLT}),
    },
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM, SPECIES_CRABOMINABLE},
                                {EVO_ITEM, ITEM_HELPER_HEART, SPECIES_CRABOMINABLE}),
    },
...
#define SILVALLY_SPECIES_INFO(type, palette)                                            \
    {                                                                                   \
        ...
        .height = 23,                                                                   \
        .weight = 1005,                                                                 \
        .description = (type == TYPE_ILLUSION                                             \
    ...
    [SPECIES_SILVALLY_NORMAL]   = SILVALLY_SPECIES_INFO(TYPE_ILLUSION, SilvallyNormal),
    [SPECIES_SILVALLY_FIGHTING] = SILVALLY_SPECIES_INFO(TYPE_DREAM, SilvallyFighting),
    [SPECIES_SILVALLY_FLYING]   = SILVALLY_SPECIES_INFO(TYPE_FLYING, SilvallyFlying),
    [SPECIES_SILVALLY_POISON]   = SILVALLY_SPECIES_INFO(TYPE_MIASMA, SilvallyPoison),
    [SPECIES_SILVALLY_GROUND]   = SILVALLY_SPECIES_INFO(TYPE_EARTH, SilvallyGround),
    [SPECIES_SILVALLY_ROCK]     = SILVALLY_SPECIES_INFO(TYPE_BEAST, SilvallyRock),
    [SPECIES_SILVALLY_BUG]      = SILVALLY_SPECIES_INFO(TYPE_HEART, SilvallyBug),
    ...
    [SPECIES_SILVALLY_GRASS]    = SILVALLY_SPECIES_INFO(TYPE_NATURE, SilvallyGrass),
    [SPECIES_SILVALLY_ELECTRIC] = SILVALLY_SPECIES_INFO(TYPE_WIND, SilvallyElectric),
    [SPECIES_SILVALLY_PSYCHIC]  = SILVALLY_SPECIES_INFO(TYPE_REASON, SilvallyPsychic),
    [SPECIES_SILVALLY_ICE]      = SILVALLY_SPECIES_INFO(TYPE_ICE, SilvallyIce),
    [SPECIES_SILVALLY_DRAGON]   = SILVALLY_SPECIES_INFO(TYPE_FAITH, SilvallyDragon),
    [SPECIES_SILVALLY_DARK]     = SILVALLY_SPECIES_INFO(TYPE_DARK, SilvallyDark),
    [SPECIES_SILVALLY_FAIRY]    = SILVALLY_SPECIES_INFO(TYPE_COSMIC, SilvallyFairy),
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_MINIOR_CORE_RED]      = MINIOR_CORE_SPECIES_INFO(Red,    SOURCE_HRTP,    0),
    [SPECIES_MINIOR_CORE_ORANGE]   = MINIOR_CORE_SPECIES_INFO(Orange, SOURCE_HRTP,    0),
    [SPECIES_MINIOR_CORE_YELLOW]   = MINIOR_CORE_SPECIES_INFO(Yellow, SOURCE_PODD, 0),
    [SPECIES_MINIOR_CORE_GREEN]    = MINIOR_CORE_SPECIES_INFO(Green,  SOURCE_LLS,  1),
    [SPECIES_MINIOR_CORE_BLUE]     = MINIOR_CORE_SPECIES_INFO(Blue,   SOURCE_SOEW,   0),
    [SPECIES_MINIOR_CORE_INDIGO]   = MINIOR_CORE_SPECIES_INFO(Indigo, SOURCE_SOEW,   0),
    [SPECIES_MINIOR_CORE_VIOLET]   = MINIOR_CORE_SPECIES_INFO(Violet, SOURCE_PCB, 2),
