...
#define SLOWKING_MISC_INFO                                      \
    ...
    [SPECIES_DEFENSE_YOUMU] =
    {
        ...
        PALETTES(DYoumu),
        ICON(DYoumu, 0),
        .footprint = gMonFootprint_DYoumu,
        LEARNSETS(DYoumu),
    },
...
#define KANGASKHAN_MISC_INFO                                    \
    ...
    [SPECIES_CHIBI_REISEN] =
    {
        ...
        PALETTES(CReisen),
        ICON(CReisen, 1),
        .footprint = gMonFootprint_CReisen,
        LEARNSETS(CReisen),
    ...
    [SPECIES_NORMAL_REISEN] =
    {
        ...
        PALETTES(Reisen),
        ICON(Reisen, 1),
        .footprint = gMonFootprint_Reisen,
        LEARNSETS(Reisen),
    },
    ...
    [SPECIES_DEFENSE_REISEN] =
    {
        ...
        PALETTES(DReisen),
        ICON(DReisen, 1),
        .footprint = gMonFootprint_DReisen,
        LEARNSETS(DReisen),
    },
    ...
    [SPECIES_TECH_REISEN] =
    {
        ...
        PALETTES(TReisen),
        ICON(TReisen, 1),
        .footprint = gMonFootprint_TReisen,
        LEARNSETS(TReisen),
    },
