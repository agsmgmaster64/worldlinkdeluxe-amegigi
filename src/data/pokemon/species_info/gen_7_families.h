...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_GRUBBIN] =
    {
        ...
        .abilities = { ABILITY_INNER_POWER, ABILITY_NONE, ABILITY_NONE },
    ...
    [SPECIES_TYPE_NULL] =
    {
        ...
        .abilities = { ABILITY_GUARD_ARMOR, ABILITY_NONE, ABILITY_NONE },
        .sourceGame = SOURCE_IN,
...
#define SILVALLY_SPECIES_INFO(type, _palette)                                       \
    ...
    [SPECIES_SILVALLY_FIGHTING] = SILVALLY_SPECIES_INFO(TYPE_DREAM, Fighting),
    [SPECIES_SILVALLY_FLYING]   = SILVALLY_SPECIES_INFO(TYPE_FLYING,   Flying),
    [SPECIES_SILVALLY_POISON]   = SILVALLY_SPECIES_INFO(TYPE_MIASMA,   Poison),
    ...
    [SPECIES_SILVALLY_BUG]      = SILVALLY_SPECIES_INFO(TYPE_HEART,      Bug),
    ...
    [SPECIES_SILVALLY_GRASS]    = SILVALLY_SPECIES_INFO(TYPE_NATURE,    Grass),
    [SPECIES_SILVALLY_ELECTRIC] = SILVALLY_SPECIES_INFO(TYPE_WIND, Electric),
    [SPECIES_SILVALLY_PSYCHIC]  = SILVALLY_SPECIES_INFO(TYPE_REASON,  Psychic),
    ...
    [SPECIES_SILVALLY_FAIRY]    = SILVALLY_SPECIES_INFO(TYPE_COSMIC,    Fairy),
