...
const struct SpeciesInfo gSpeciesInfoTouhou9[] =
{
    ...
    [SPECIES_NORMAL_AYA] =
    {
        ...
        .speciesName = _("Aya"),
        .cryId = CRY_AYA,
        .natDexNum = NATIONAL_DEX_NORMAL_AYA,
        .categoryName = _("Reporter"),
        .height = 6,
        .weight = 500,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SPEED_AYA] =
    {
        ...
        .speciesName = _("SAya"),
        .cryId = CRY_AYA,
        .natDexNum = NATIONAL_DEX_SPEED_AYA,
        .categoryName = _("Reporter"),
        .height = 6,
        .weight = 500,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TECH_AYA] =
    {
        ...
        .speciesName = _("TAya"),
        .cryId = CRY_AYA,
        .natDexNum = NATIONAL_DEX_TECH_AYA,
        .categoryName = _("Reporter"),
        .height = 6,
        .weight = 500,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CHIBI_MEDICINE] =
    {
        ...
        .abilities = { ABILITY_POISON_BODY, ABILITY_CHLOROPHYLL, ABILITY_MERCILESS },
        .sourceGame = SOURCE_POFV,
        .noFlip = TRUE,
        .speciesName = _("CMedicine"),
        .cryId = CRY_MEDICINE,
        .natDexNum = NATIONAL_DEX_CHIBI_MEDICINE,
    ...
    [SPECIES_TECH_MEDICINE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_GRASS),
        .abilities = { ABILITY_TOXIC_BOOST, ABILITY_CHLOROPHYLL, ABILITY_MERCILESS },
        .sourceGame = SOURCE_POFV,
        .noFlip = TRUE,
    ...
    [SPECIES_CHIBI_MEDICINE_SANNI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_GRASS),
        .abilities = { ABILITY_FOUL_AROMA, ABILITY_CHLOROPHYLL, ABILITY_IMMUNITY },
        .sourceGame = SOURCE_POFV,
        .noFlip = TRUE,
        .speciesName = _("CMedicine"),
        .cryId = CRY_MEDICINE,
        .natDexNum = NATIONAL_DEX_CHIBI_MEDICINE,
        .categoryName = _("Odd Doll"),
        .height = 3,
        .weight = 100,
        .description = COMPOUND_STRING(
            "Kabutops once swam underwater to hunt \n"
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_CMedicineSanni,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_GenericBlinkingAnim,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_CMedicineSanni,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_CMedicineSanni,
        .shinyPalette = gMonShinyPalette_CMedicineSanni,
        .iconSprite = gMonIcon_CMedicineSanni,
        .iconPalIndex = 1,
        SHADOW(4, 7, SHADOW_SIZE_M)
        FOOTPRINT(CMedicineSanni)
        .isSannianForm = TRUE,
        .levelUpLearnset = sCMedicineSanniLevelUpLearnset,
        .teachableLearnset = sCMedicineSanniTeachableLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_NORMAL_MEDICINE_SANNI},
                                {EVO_ITEM, ITEM_NEUTRAL_HEART, SPECIES_NORMAL_MEDICINE_SANNI, CONDITIONS({IF_PAST_LEVEL, 25})}),
    },

    [SPECIES_NORMAL_MEDICINE_SANNI] =
    {
        .baseHP        = 100,
        .baseAttack    = 60,
        .baseDefense   = 95,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_GRASS),
        .abilities = { ABILITY_FOUL_AROMA, ABILITY_CHLOROPHYLL, ABILITY_POISON_HEAL },
        .sourceGame = SOURCE_POFV,
        .noFlip = TRUE,
        .speciesName = _("Medicine"),
        .cryId = CRY_MEDICINE,
        ...
        .trainerScale = 302,
        .trainerOffset = 4,
        .frontPic = gMonFrontPic_MedicineSanni,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_GenericBlinkingAnim,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 4,
        .backPic = gMonBackPic_MedicineSanni,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_MedicineSanni,
        .shinyPalette = gMonShinyPalette_MedicineSanni,
        .iconSprite = gMonIcon_MedicineSanni,
        .iconPalIndex = 1,
        SHADOW(0, 12, SHADOW_SIZE_M)
        FOOTPRINT(MedicineSanni)
        .isSannianForm = TRUE,
        .levelUpLearnset = sMedicineSanniLevelUpLearnset,
        .teachableLearnset = sMedicineSanniTeachableLearnset,
    },
    ...
    [SPECIES_NORMAL_YUUKA] =
    {
        ...
        .speciesName = _("Yuuka"),
        .cryId = CRY_YUUKA,
        .natDexNum = NATIONAL_DEX_NORMAL_YUUKA,
        .categoryName = _("Sun Flower"),
        .height = 7,
        .weight = 1000,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_ATTACK_YUUKA] =
    {
        ...
        .cryId = CRY_YUUKA,
        .natDexNum = NATIONAL_DEX_ATTACK_YUUKA,
        .categoryName = _("Sun Flower"),
        .height = 7,
        .weight = 1000,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TECH_YUUKA] =
    {
        ...
        .cryId = CRY_YUUKA,
        .natDexNum = NATIONAL_DEX_TECH_YUUKA,
        .categoryName = _("Sun Flower"),
        .height = 7,
        .weight = 1000,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CHIBI_KOMACHI] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_SWIFT_SWIM, ABILITY_INTIMIDATE },
        .sourceGame = SOURCE_POFV,
        .noFlip = TRUE,
    ...
    [SPECIES_NORMAL_KOMACHI] =
    {
        ...
        .cryId = CRY_KOMACHI,
        .natDexNum = NATIONAL_DEX_NORMAL_KOMACHI,
        .categoryName = _("Ferryman"),
        .height = 7,
        .weight = 500,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_ATTACK_KOMACHI] =
    {
        ...
        .cryId = CRY_KOMACHI,
        .natDexNum = NATIONAL_DEX_ATTACK_KOMACHI,
        .categoryName = _("Ferryman"),
        .height = 7,
        .weight = 500,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SPEED_KOMACHI] =
    {
        ...
        .cryId = CRY_KOMACHI,
        .natDexNum = NATIONAL_DEX_SPEED_KOMACHI,
        .categoryName = _("Ferryman"),
        .height = 7,
        .weight = 500,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CHIBI_EIKI] =
    {
        ...
        .speciesName = _("CEiki"),
        .cryId = CRY_EIKI,
        .natDexNum = NATIONAL_DEX_CHIBI_EIKI,
    ...
    [SPECIES_NORMAL_EIKI] =
    {
        ...
        .speciesName = _("Eiki"),
        .cryId = CRY_EIKI,
        .natDexNum = NATIONAL_DEX_NORMAL_EIKI,
        .categoryName = _("Judge"),
        .height = 5,
        .weight = 2100,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_ATTACK_EIKI] =
    {
        ...
        .speciesName = _("AEiki"),
        .cryId = CRY_EIKI,
        .natDexNum = NATIONAL_DEX_ATTACK_EIKI,
        .categoryName = _("Judge"),
        .height = 5,
        .weight = 2100,
        .description = COMPOUND_STRING(
