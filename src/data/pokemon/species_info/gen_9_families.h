...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_OINKOLOGNE_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CLEAR_VOICE, ABILITY_GLUTTONY, ABILITY_WALL_OF_ICE },
        .sourceGame = SOURCE_IN,
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 40,
        .types = MON_TYPES(TYPE_WIND, TYPE_DREAM),
        .catchRate = 80,
        .expYield = 123,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SMOLIV] =
    {
        ...
        .baseSpAttack  = 58,
        .baseSpDefense = 51,
        .types = MON_TYPES(TYPE_NATURE, TYPE_ILLUSION),
        .catchRate = 255,
        .expYield = 52,
        .evYield_SpAttack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_ARBOLIVA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_FOUL_AROMA, ABILITY_NONE, ABILITY_HARVEST },
        .sourceGame = SOURCE_LLS,
    ...
    [SPECIES_NACLI] =
    {
        ...
        .abilities = { ABILITY_LIFESTREAM, ABILITY_STURDY, ABILITY_HAKUREI_MIKO },
        .sourceGame = SOURCE_EOSD,
        .speciesName = _("Nacli"),
        .cryId = CRY_PORYGON,
    ...
    [SPECIES_SHROODLE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 35,
        .types = MON_TYPES(TYPE_MIASMA, TYPE_ILLUSION),
        .catchRate = 190,
        .expYield = 58,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .baseSpAttack  = 45,
        .baseSpDefense = 35,
        .types = MON_TYPES(TYPE_NATURE, TYPE_GHOST),
        .catchRate = 190,
        .expYield = 55,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 100,
        .types = MON_TYPES(TYPE_EARTH, TYPE_NATURE),
        .catchRate = 190,
        .expYield = 67,
        .evYield_SpDefense = 1,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_AMBITION, ABILITY_NONE, ABILITY_NONE },
        .sourceGame = SOURCE_PODD,
    ...
    [SPECIES_VAROOM] =
    {
        ...
        .baseSpAttack  = 30,
        .baseSpDefense = 45,
        .types = MON_TYPES(TYPE_STEEL, TYPE_MIASMA),
        .catchRate = 190,
        .expYield = 60,
        .evYield_Attack = 1,
        .genderRatio = PERCENT_FEMALE(50),
    ...
    [SPECIES_SCREAM_TAIL] =
    {
        ...
        .baseSpAttack  = 65,
        .baseSpDefense = 115,
        .types = MON_TYPES(TYPE_COSMIC, TYPE_REASON),
        .catchRate = 50,
        .expYield = 285,
        .evYield_HP = 3,
        .itemRare = ITEM_BOOSTER_ENERGY,
    ...
    [SPECIES_SANDY_SHOCKS] =
    {
        ...
        .baseSpAttack  = 121,
        .baseSpDefense = 85,
        .types = MON_TYPES(TYPE_WIND, TYPE_EARTH),
        .catchRate = 30,
        .expYield = 285,
        .evYield_SpAttack = 3,
        .itemRare = ITEM_BOOSTER_ENERGY,
    ...
    [SPECIES_IRON_HANDS] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 68,
        .types = MON_TYPES(TYPE_DREAM, TYPE_WIND),
        .catchRate = 50,
        .expYield = 285,
        .evYield_Attack = 3,
        .itemRare = ITEM_BOOSTER_ENERGY,
    ...
    [SPECIES_IRON_VALIANT] =
    {
        ...
        .baseSpAttack  = 120,
        .baseSpDefense = 60,
        .types = MON_TYPES(TYPE_COSMIC, TYPE_DREAM),
        .catchRate = 10,
        .expYield = 295,
        .evYield_Attack = 3,
        .itemRare = ITEM_BOOSTER_ENERGY,
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, frontYOffset, backYOffset, iconpalette, isTeraform)    \
    ...
    [SPECIES_OGERPON_TEAL]             = OGERPON_SPECIES_INFO(Teal,        Teal,            TYPE_NATURE, ABILITY_DEFIANT,                        SOURCE_OTHER, 1, 6, 1, FALSE),
    [SPECIES_OGERPON_WELLSPRING]       = OGERPON_SPECIES_INFO(Wellspring,  Wellspring,      TYPE_WATER, ABILITY_WATER_ABSORB,                   SOURCE_OTHER,  1, 6, 0, FALSE),
    [SPECIES_OGERPON_HEARTHFLAME]      = OGERPON_SPECIES_INFO(Hearthflame, Hearthflame,     TYPE_FIRE,  ABILITY_MOLD_BREAKER,                   SOURCE_OTHER,   1, 6, 0, FALSE),
    [SPECIES_OGERPON_CORNERSTONE]      = OGERPON_SPECIES_INFO(Cornerstone, Cornerstone,     TYPE_BEAST,  ABILITY_STURDY,                         SOURCE_OTHER,  1, 6, 0, FALSE),
#if P_TERA_FORMS
    [SPECIES_OGERPON_TEAL_TERA]        = OGERPON_SPECIES_INFO(Teal,        TealTera,        TYPE_NATURE, ABILITY_EMBODY_ASPECT_TEAL_MASK,        SOURCE_OTHER, 0, 0, 1, TRUE),
    [SPECIES_OGERPON_WELLSPRING_TERA]  = OGERPON_SPECIES_INFO(Wellspring,  WellspringTera,  TYPE_WATER, ABILITY_EMBODY_ASPECT_WELLSPRING_MASK,  SOURCE_OTHER,  0, 0, 0, TRUE),
    [SPECIES_OGERPON_HEARTHFLAME_TERA] = OGERPON_SPECIES_INFO(Hearthflame, HearthflameTera, TYPE_FIRE,  ABILITY_EMBODY_ASPECT_HEARTHFLAME_MASK, SOURCE_OTHER,   0, 0, 0, TRUE),
    [SPECIES_OGERPON_CORNERSTONE_TERA] = OGERPON_SPECIES_INFO(Cornerstone, CornerstoneTera, TYPE_BEAST,  ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, SOURCE_OTHER,  0, 0, 0, TRUE),
#endif //P_TERA_FORMS
