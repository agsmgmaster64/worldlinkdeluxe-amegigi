...
{
    [SPECIES_CHIBI_REIMU]           = {{EVO_LEVEL, 16, SPECIES_NORMAL_REIMU}},
    [SPECIES_NORMAL_REIMU]          = {{EVO_LEVEL, 32, SPECIES_ATTACK_REIMU}},
    [SPECIES_DEFENSE_REIMU]         = {{EVO_LEVEL, 16, SPECIES_CHIBI_MARISA}},
    [SPECIES_CHIBI_MARISA]          = {{EVO_LEVEL, 36, SPECIES_NORMAL_MARISA}},
    [SPECIES_ATTACK_MARISA]         = {{EVO_LEVEL, 16, SPECIES_SPEED_MARISA}},
    [SPECIES_SPEED_MARISA]          = {{EVO_LEVEL, 36, SPECIES_CHIBI_DAIYOUSEI}},
    [SPECIES_NORMAL_DAIYOUSEI]      = {{EVO_LEVEL, 7, SPECIES_ATTACK_DAIYOUSEI}},
    [SPECIES_ATTACK_DAIYOUSEI]      = {{EVO_LEVEL, 10, SPECIES_DEFENSE_DAIYOUSEI}},
    [SPECIES_CHIBI_CIRNO]                = {{EVO_LEVEL, 7, SPECIES_NORMAL_CIRNO}},
    [SPECIES_NORMAL_CIRNO]                = {{EVO_LEVEL, 10, SPECIES_SPEED_CIRNO}},
    [SPECIES_TECH_CIRNO]                = {{EVO_LEVEL, 18, SPECIES_CHIBI_RUMIA}},
    [SPECIES_CHIBI_RUMIA]             = {{EVO_LEVEL, 36, SPECIES_NORMAL_RUMIA}},
    [SPECIES_ATTACK_RUMIA]               = {{EVO_LEVEL, 20, SPECIES_SPEED_RUMIA}},
    [SPECIES_CHIBI_MEILING]               = {{EVO_LEVEL, 20, SPECIES_NORMAL_MEILING}},
    [SPECIES_DEFENSE_MEILING]                 = {{EVO_LEVEL, 22, SPECIES_SPEED_MEILING}},
    [SPECIES_CHIBI_KOAKUMA]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_NORMAL_KOAKUMA},
                                       {EVO_NONE, 0, SPECIES_RAICHU_ALOLAN}},
    [SPECIES_HELPER_KOAKUMA]             = {{EVO_LEVEL, 22, SPECIES_PLCEHOLDER1_KOAKUMA}},
    [SPECIES_CHIBI_PATCHOULI]             = {{EVO_LEVEL, 16, SPECIES_NORMAL_PATCHOULI}},
    [SPECIES_NORMAL_PATCHOULI]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_ATTACK_PATCHOULI}},
    [SPECIES_DEFENSE_PATCHOULI]             = {{EVO_LEVEL, 16, SPECIES_NIDORINO}},
...
#endif
    [SPECIES_HORSEA]                = {{EVO_LEVEL, 32, SPECIES_CHIBI_REISEN}},
    [SPECIES_CHIBI_REISEN]                = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
                                       {EVO_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA}},
    [SPECIES_NORMAL_REISEN]               = {{EVO_LEVEL, 33, SPECIES_DEFENSE_REISEN}},
    [SPECIES_TECH_REISEN]                = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    ...
    [SPECIES_PICHU]                 = {{EVO_FRIENDSHIP, 0, SPECIES_CHIBI_KOAKUMA}},
