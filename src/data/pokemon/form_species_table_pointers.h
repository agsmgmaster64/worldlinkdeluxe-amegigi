...
{
    [SPECIES_ATTACK_REIMU] = sVenusaurFormSpeciesIdTable,
    [SPECIES_NORMAL_MARISA] = sCharizardFormSpeciesIdTable,
    [SPECIES_CHIBI_DAIYOUSEI] = sBlastoiseFormSpeciesIdTable,
    [SPECIES_SPEED_CIRNO] = sBeedrillFormSpeciesIdTable,
    [SPECIES_NORMAL_RUMIA] = sPidgeotFormSpeciesIdTable,
    [SPECIES_ATTACK_RUMIA] = sRattataFormSpeciesIdTable,
    [SPECIES_SPEED_RUMIA] = sRaticateFormSpeciesIdTable,
    [SPECIES_CHIBI_KOAKUMA] = sPikachuFormSpeciesIdTable,
    [SPECIES_NORMAL_KOAKUMA] = sRaichuFormSpeciesIdTable,
    [SPECIES_HELPER_KOAKUMA] = sSandshrewFormSpeciesIdTable,
    [SPECIES_PLCEHOLDER1_KOAKUMA] = sSandslashFormSpeciesIdTable,
...
// Attack, Defense, Speed, Technical
