const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_BULBASAUR] = sCReimuLevelUpLearnset,
    [SPECIES_IVYSAUR] = sReimuLevelUpLearnset,
    [SPECIES_VENUSAUR] = sAReimuLevelUpLearnset,
    [SPECIES_CHARMANDER] = sDReimuLevelUpLearnset,
    [SPECIES_CHARMELEON] = sCMarisaLevelUpLearnset,
    [SPECIES_CHARIZARD] = sMarisaLevelUpLearnset,
    [SPECIES_SQUIRTLE] = sAMarisaLevelUpLearnset,
    [SPECIES_WARTORTLE] = sSMarisaLevelUpLearnset,
    [SPECIES_BLASTOISE] = sCDaiyouseiLevelUpLearnset,
    [SPECIES_CATERPIE] = sDaiyouseiLevelUpLearnset,
    [SPECIES_METAPOD] = sADaiyouseiLevelUpLearnset,
    [SPECIES_BUTTERFREE] = sDDaiyouseiLevelUpLearnset,
    [SPECIES_WEEDLE] = sCCirnoLevelUpLearnset,
    [SPECIES_KAKUNA] = sCirnoLevelUpLearnset,
    [SPECIES_BEEDRILL] = sSCirnoLevelUpLearnset,
    [SPECIES_PIDGEY] = sTCirnoLevelUpLearnset,
