const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_RENKO] = TRAINER_PIC_FRONT_RENKO,
    [FACILITY_CLASS_BRENDAN_2] = TRAINER_PIC_FRONT_RENKO,
    [FACILITY_CLASS_BRENDAN_3] = TRAINER_PIC_FRONT_RENKO,
    [FACILITY_CLASS_MARIBEL] = TRAINER_PIC_FRONT_MARIBEL,
    [FACILITY_CLASS_MAY_2] = TRAINER_PIC_FRONT_MARIBEL,
    [FACILITY_CLASS_MAY_3] = TRAINER_PIC_FRONT_MARIBEL,
