const struct CompressedSpriteSheet gMonFrontPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(CHIBI_REIMU, gMonFrontPic_Bulbasaur),
    SPECIES_SPRITE(NORMAL_REIMU, gMonFrontPic_Ivysaur),
    SPECIES_SPRITE(ATTACK_REIMU, gMonFrontPic_Venusaur),
    SPECIES_SPRITE(DEFENSE_REIMU, gMonFrontPic_Charmander),
    SPECIES_SPRITE(CHIBI_MARISA, gMonFrontPic_Charmeleon),
    SPECIES_SPRITE(NORMAL_MARISA, gMonFrontPic_Charizard),
    SPECIES_SPRITE(ATTACK_MARISA, gMonFrontPic_Squirtle),
    SPECIES_SPRITE(SPEED_MARISA, gMonFrontPic_Wartortle),
    SPECIES_SPRITE(CHIBI_DAIYOUSEI, gMonFrontPic_Blastoise),
    SPECIES_SPRITE(NORMAL_DAIYOUSEI, gMonFrontPic_Caterpie),
    SPECIES_SPRITE(ATTACK_DAIYOUSEI, gMonFrontPic_Metapod),
    SPECIES_SPRITE(DEFENSE_DAIYOUSEI, gMonFrontPic_Butterfree),
    SPECIES_SPRITE(CHIBI_CIRNO, gMonFrontPic_Weedle),
    SPECIES_SPRITE(NORMAL_CIRNO, gMonFrontPic_Kakuna),
    SPECIES_SPRITE(SPEED_CIRNO, gMonFrontPic_Beedrill),
    SPECIES_SPRITE(TECH_CIRNO, gMonFrontPic_Pidgey),
    SPECIES_SPRITE(CHIBI_RUMIA, gMonFrontPic_Pidgeotto),
    SPECIES_SPRITE(NORMAL_RUMIA, gMonFrontPic_Pidgeot),
    SPECIES_SPRITE(ATTACK_RUMIA, gMonFrontPic_Rattata),
    SPECIES_SPRITE(SPEED_RUMIA, gMonFrontPic_Raticate),
    SPECIES_SPRITE(CHIBI_MEILING, gMonFrontPic_Spearow),
    SPECIES_SPRITE(NORMAL_MEILING, gMonFrontPic_Fearow),
    SPECIES_SPRITE(DEFENSE_MEILING, gMonFrontPic_Ekans),
    SPECIES_SPRITE(SPEED_MEILING, gMonFrontPic_Arbok),
    SPECIES_SPRITE(CHIBI_KOAKUMA, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(NORMAL_KOAKUMA, gMonFrontPic_Raichu),
    SPECIES_SPRITE(HELPER_KOAKUMA, gMonFrontPic_Sandshrew),
    SPECIES_SPRITE(PLCEHOLDER1_KOAKUMA, gMonFrontPic_Sandslash),
    SPECIES_SPRITE(CHIBI_PATCHOULI, gMonFrontPic_NidoranF),
    SPECIES_SPRITE(NORMAL_PATCHOULI, gMonFrontPic_Nidorina),
    SPECIES_SPRITE(ATTACK_PATCHOULI, gMonFrontPic_Nidoqueen),
    SPECIES_SPRITE(DEFENSE_PATCHOULI, gMonFrontPic_NidoranM),
    ...
    SPECIES_SPRITE(CHIBI_YOUMU, gMonFrontPic_THYoumu1),
    SPECIES_SPRITE(NORMAL_YOUMU, gMonFrontPic_THYoumu2N),
    SPECIES_SPRITE(DEFENSE_YOUMU, gMonFrontPic_THYoumu2D),
    SPECIES_SPRITE(SPEED_YOUMU, gMonFrontPic_THYoumu2S),
    ...
    SPECIES_SPRITE(CHIBI_REISEN, gMonFrontPic_THReisen1),
    SPECIES_SPRITE(NORMAL_REISEN, gMonFrontPic_THReisen2N),
    SPECIES_SPRITE(DEFENSE_REISEN, gMonFrontPic_THReisen2D),
    SPECIES_SPRITE(TECH_REISEN, gMonFrontPic_THReisen2T),
