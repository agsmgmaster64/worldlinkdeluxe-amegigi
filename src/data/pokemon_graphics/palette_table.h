const struct CompressedSpritePalette gMonPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_PAL(CHIBI_REIMU, gMonPalette_Bulbasaur),
    SPECIES_PAL(NORMAL_REIMU, gMonPalette_Ivysaur),
    SPECIES_PAL(ATTACK_REIMU, gMonPalette_Venusaur),
    SPECIES_PAL(DEFENSE_REIMU, gMonPalette_Charmander),
    SPECIES_PAL(CHIBI_MARISA, gMonPalette_Charmeleon),
    SPECIES_PAL(NORMAL_MARISA, gMonPalette_Charizard),
    SPECIES_PAL(ATTACK_MARISA, gMonPalette_Squirtle),
    SPECIES_PAL(SPEED_MARISA, gMonPalette_Wartortle),
    SPECIES_PAL(CHIBI_DAIYOUSEI, gMonPalette_Blastoise),
    SPECIES_PAL(NORMAL_DAIYOUSEI, gMonPalette_Caterpie),
    SPECIES_PAL(ATTACK_DAIYOUSEI, gMonPalette_Metapod),
    SPECIES_PAL(DEFENSE_DAIYOUSEI, gMonPalette_Butterfree),
    SPECIES_PAL(CHIBI_CIRNO, gMonPalette_Weedle),
    SPECIES_PAL(NORMAL_CIRNO, gMonPalette_Kakuna),
    SPECIES_PAL(SPEED_CIRNO, gMonPalette_Beedrill),
    SPECIES_PAL(TECH_CIRNO, gMonPalette_Pidgey),
    SPECIES_PAL(CHIBI_RUMIA, gMonPalette_Pidgeotto),
    SPECIES_PAL(NORMAL_RUMIA, gMonPalette_Pidgeot),
    SPECIES_PAL(ATTACK_RUMIA, gMonPalette_Rattata),
    SPECIES_PAL(SPEED_RUMIA, gMonPalette_Raticate),
    SPECIES_PAL(CHIBI_MEILING, gMonPalette_Spearow),
    SPECIES_PAL(NORMAL_MEILING, gMonPalette_Fearow),
    SPECIES_PAL(DEFENSE_MEILING, gMonPalette_Ekans),
    SPECIES_PAL(SPEED_MEILING, gMonPalette_Arbok),
    SPECIES_PAL(CHIBI_KOAKUMA, gMonPalette_Pikachu),
    SPECIES_PAL(NORMAL_KOAKUMA, gMonPalette_Raichu),
    SPECIES_PAL(HELPER_KOAKUMA, gMonPalette_Sandshrew),
    SPECIES_PAL(PLCEHOLDER1_KOAKUMA, gMonPalette_Sandslash),
    SPECIES_PAL(CHIBI_PATCHOULI, gMonPalette_NidoranF),
    SPECIES_PAL(NORMAL_PATCHOULI, gMonPalette_Nidorina),
    SPECIES_PAL(ATTACK_PATCHOULI, gMonPalette_Nidoqueen),
    SPECIES_PAL(DEFENSE_PATCHOULI, gMonPalette_NidoranM),
    ...
    SPECIES_PAL(CHIBI_YOUMU, gMonPalette_THYoumu1),
    SPECIES_PAL(NORMAL_YOUMU, gMonPalette_THYoumu2N),
    SPECIES_PAL(DEFENSE_YOUMU, gMonPalette_THYoumu2D),
    SPECIES_PAL(SPEED_YOUMU, gMonPalette_THYoumu2S),
    ...
    SPECIES_PAL(CHIBI_REISEN, gMonPalette_Seadra),
    SPECIES_PAL(NORMAL_REISEN, gMonPalette_Goldeen),
    SPECIES_PAL(DEFENSE_REISEN, gMonPalette_Seaking),
    SPECIES_PAL(TECH_REISEN, gMonPalette_Staryu),
