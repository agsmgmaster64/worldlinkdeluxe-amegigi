...
#define BLINKING_ANIM_FRAMES(name)              \
static const union AnimCmd sAnim_##name##_1[] = \
{                                               \
    ANIMCMD_FRAME(0, 15),                       \
    ANIMCMD_FRAME(1, 15),                       \
...
BLINKING_ANIM_FRAMES(CReimu);
BLINKING_ANIM_FRAMES(Reimu);
BLINKING_ANIM_FRAMES(AReimu);
BLINKING_ANIM_FRAMES(DReimu);

BLINKING_ANIM_FRAMES(CMarisa);
BLINKING_ANIM_FRAMES(Marisa);
BLINKING_ANIM_FRAMES(AMarisa);
BLINKING_ANIM_FRAMES(SMarisa);
BLINKING_ANIM_FRAMES(AdMarisa);

BLINKING_ANIM_FRAMES(CDaiyousei);
BLINKING_ANIM_FRAMES(Daiyousei);
BLINKING_ANIM_FRAMES(ADaiyousei);
BLINKING_ANIM_FRAMES(DDaiyousei);

BLINKING_ANIM_FRAMES(CCirno);
BLINKING_ANIM_FRAMES(Cirno);
BLINKING_ANIM_FRAMES(SCirno);
BLINKING_ANIM_FRAMES(TCirno);
BLINKING_ANIM_FRAMES(AdCirno);

BLINKING_ANIM_FRAMES(CRumia);
BLINKING_ANIM_FRAMES(Rumia);
BLINKING_ANIM_FRAMES(ARumia);
BLINKING_ANIM_FRAMES(SRumia);

BLINKING_ANIM_FRAMES(CMeiling);
BLINKING_ANIM_FRAMES(Meiling);
BLINKING_ANIM_FRAMES(DMeiling);
BLINKING_ANIM_FRAMES(SMeiling);
BLINKING_ANIM_FRAMES(AdMeiling);

BLINKING_ANIM_FRAMES(CKoakuma);
BLINKING_ANIM_FRAMES(Koakuma);
BLINKING_ANIM_FRAMES(HKoakuma);
//BLINKING_ANIM_FRAMES(PKoakuma);

BLINKING_ANIM_FRAMES(CPatchouli);
BLINKING_ANIM_FRAMES(Patchouli);
BLINKING_ANIM_FRAMES(APatchouli);
BLINKING_ANIM_FRAMES(DPatchouli);

BLINKING_ANIM_FRAMES(CSakuya);
BLINKING_ANIM_FRAMES(Sakuya);
BLINKING_ANIM_FRAMES(TSakuya);
BLINKING_ANIM_FRAMES(HSakuya);

BLINKING_ANIM_FRAMES(CRemilia);
BLINKING_ANIM_FRAMES(Remilia);
BLINKING_ANIM_FRAMES(ARemilia);
BLINKING_ANIM_FRAMES(DRemilia);

BLINKING_ANIM_FRAMES(CFlandre);
BLINKING_ANIM_FRAMES(Flandre);
BLINKING_ANIM_FRAMES(AFlandre);
BLINKING_ANIM_FRAMES(SFlandre);

BLINKING_ANIM_FRAMES(CLetty);
BLINKING_ANIM_FRAMES(Letty);
BLINKING_ANIM_FRAMES(DLetty);
BLINKING_ANIM_FRAMES(HLetty);
BLINKING_ANIM_FRAMES(AdLetty);

BLINKING_ANIM_FRAMES(Shanghai);
BLINKING_ANIM_FRAMES(Hourai);
BLINKING_ANIM_FRAMES(Goliath);

BLINKING_ANIM_FRAMES(CAlice);
BLINKING_ANIM_FRAMES(Alice);
BLINKING_ANIM_FRAMES(AAlice);
BLINKING_ANIM_FRAMES(TAlice);
BLINKING_ANIM_FRAMES(AdAlice);

BLINKING_ANIM_FRAMES(CLilyWhite);
BLINKING_ANIM_FRAMES(LilyWhite);
BLINKING_ANIM_FRAMES(ALilyWhite);
BLINKING_ANIM_FRAMES(HLilyWhite);

BLINKING_ANIM_FRAMES(CLilyBlack);
BLINKING_ANIM_FRAMES(LilyBlack);
BLINKING_ANIM_FRAMES(ALilyBlack);
BLINKING_ANIM_FRAMES(SLilyBlack);

BLINKING_ANIM_FRAMES(CLunasa);
BLINKING_ANIM_FRAMES(Lunasa);
BLINKING_ANIM_FRAMES(HLunasa);
//BLINKING_ANIM_FRAMES(PLunasa);

BLINKING_ANIM_FRAMES(CMerlin);
BLINKING_ANIM_FRAMES(Merlin);
BLINKING_ANIM_FRAMES(HMerlin);
//BLINKING_ANIM_FRAMES(PMerlin);

BLINKING_ANIM_FRAMES(CLyrica);
BLINKING_ANIM_FRAMES(Lyrica);
BLINKING_ANIM_FRAMES(HLyrica);
//BLINKING_ANIM_FRAMES(PLyrica);

BLINKING_ANIM_FRAMES(CLayla);
BLINKING_ANIM_FRAMES(Layla);
BLINKING_ANIM_FRAMES(DLayla);
//BLINKING_ANIM_FRAMES(PLayla);

BLINKING_ANIM_FRAMES(CYoumu);
BLINKING_ANIM_FRAMES(Youmu);
BLINKING_ANIM_FRAMES(DYoumu);
BLINKING_ANIM_FRAMES(SYoumu);
BLINKING_ANIM_FRAMES(AdYoumu);

BLINKING_ANIM_FRAMES(CYoumuOld);
BLINKING_ANIM_FRAMES(YoumuOld);
BLINKING_ANIM_FRAMES(EYoumuOld);

BLINKING_ANIM_FRAMES(CYuyuko);
BLINKING_ANIM_FRAMES(Yuyuko);
BLINKING_ANIM_FRAMES(AYuyuko);
BLINKING_ANIM_FRAMES(DYuyuko);
BLINKING_ANIM_FRAMES(AdYuyuko);

BLINKING_ANIM_FRAMES(CChen);
BLINKING_ANIM_FRAMES(Chen);
BLINKING_ANIM_FRAMES(AChen);
BLINKING_ANIM_FRAMES(TChen);
BLINKING_ANIM_FRAMES(AdChen);

BLINKING_ANIM_FRAMES(CRan);
BLINKING_ANIM_FRAMES(Ran);
BLINKING_ANIM_FRAMES(ARan);
BLINKING_ANIM_FRAMES(HRan);
BLINKING_ANIM_FRAMES(AdRan);

BLINKING_ANIM_FRAMES(CYukari);
BLINKING_ANIM_FRAMES(Yukari);
BLINKING_ANIM_FRAMES(DYukari);
BLINKING_ANIM_FRAMES(TYukari);
BLINKING_ANIM_FRAMES(AdYukari);

BLINKING_ANIM_FRAMES(CWriggle);
BLINKING_ANIM_FRAMES(Wriggle);
BLINKING_ANIM_FRAMES(DWriggle);
BLINKING_ANIM_FRAMES(SWriggle);

BLINKING_ANIM_FRAMES(CMystia);
BLINKING_ANIM_FRAMES(Mystia);
BLINKING_ANIM_FRAMES(AMystia);
BLINKING_ANIM_FRAMES(HMystia);
BLINKING_ANIM_FRAMES(AdMystia);

BLINKING_ANIM_FRAMES(CKeine);
BLINKING_ANIM_FRAMES(Keine);
BLINKING_ANIM_FRAMES(AKeine);
BLINKING_ANIM_FRAMES(DKeine);
BLINKING_ANIM_FRAMES(HKeine);

BLINKING_ANIM_FRAMES(CTewi);
BLINKING_ANIM_FRAMES(Tewi);
BLINKING_ANIM_FRAMES(ATewi);
BLINKING_ANIM_FRAMES(DTewi);
BLINKING_ANIM_FRAMES(AdTewi);

BLINKING_ANIM_FRAMES(CReisen);
BLINKING_ANIM_FRAMES(Reisen);
BLINKING_ANIM_FRAMES(DReisen);
BLINKING_ANIM_FRAMES(TReisen);
BLINKING_ANIM_FRAMES(AdReisen);

BLINKING_ANIM_FRAMES(CReisenII);
BLINKING_ANIM_FRAMES(ReisenII);

BLINKING_ANIM_FRAMES(CEirin);
BLINKING_ANIM_FRAMES(Eirin);
BLINKING_ANIM_FRAMES(AEirin);
BLINKING_ANIM_FRAMES(HEirin);

BLINKING_ANIM_FRAMES(CKaguya);
BLINKING_ANIM_FRAMES(Kaguya);
BLINKING_ANIM_FRAMES(AKaguya);
BLINKING_ANIM_FRAMES(DKaguya);

BLINKING_ANIM_FRAMES(CMokou);
BLINKING_ANIM_FRAMES(Mokou);
BLINKING_ANIM_FRAMES(AMokou);
BLINKING_ANIM_FRAMES(DMokou);
BLINKING_ANIM_FRAMES(AdMokou);

BLINKING_ANIM_FRAMES(CAya);
BLINKING_ANIM_FRAMES(Aya);
BLINKING_ANIM_FRAMES(SAya);
BLINKING_ANIM_FRAMES(TAya);

BLINKING_ANIM_FRAMES(CMedicine);
BLINKING_ANIM_FRAMES(Medicine);
BLINKING_ANIM_FRAMES(AMedicine);
BLINKING_ANIM_FRAMES(SMedicine);
BLINKING_ANIM_FRAMES(TMedicine);

BLINKING_ANIM_FRAMES(CYuuka);
BLINKING_ANIM_FRAMES(Yuuka);
BLINKING_ANIM_FRAMES(AYuuka);
BLINKING_ANIM_FRAMES(TYuuka);

BLINKING_ANIM_FRAMES(CKomachi);
BLINKING_ANIM_FRAMES(Komachi);
BLINKING_ANIM_FRAMES(AKomachi);
BLINKING_ANIM_FRAMES(SKomachi);

BLINKING_ANIM_FRAMES(CEiki);
BLINKING_ANIM_FRAMES(Eiki);
BLINKING_ANIM_FRAMES(AEiki);
BLINKING_ANIM_FRAMES(DEiki);

BLINKING_ANIM_FRAMES(CShizuha);
BLINKING_ANIM_FRAMES(Shizuha);
BLINKING_ANIM_FRAMES(SShizuha);
BLINKING_ANIM_FRAMES(HShizuha);

BLINKING_ANIM_FRAMES(CShizuhaSannian);
BLINKING_ANIM_FRAMES(ShizuhaSannian);

BLINKING_ANIM_FRAMES(CMinoriko);
BLINKING_ANIM_FRAMES(Minoriko);
BLINKING_ANIM_FRAMES(AMinoriko);
BLINKING_ANIM_FRAMES(DMinoriko);

BLINKING_ANIM_FRAMES(CMinorikoSannian);
BLINKING_ANIM_FRAMES(MinorikoSannian);

BLINKING_ANIM_FRAMES(CHina);
BLINKING_ANIM_FRAMES(Hina);
BLINKING_ANIM_FRAMES(AHina);
BLINKING_ANIM_FRAMES(DHina);

BLINKING_ANIM_FRAMES(CNitori);
BLINKING_ANIM_FRAMES(Nitori);
BLINKING_ANIM_FRAMES(ANitori);
BLINKING_ANIM_FRAMES(TNitori);

BLINKING_ANIM_FRAMES(CMomiji);
BLINKING_ANIM_FRAMES(Momiji);
BLINKING_ANIM_FRAMES(DMomiji);

BLINKING_ANIM_FRAMES(CSanae);
BLINKING_ANIM_FRAMES(Sanae);
BLINKING_ANIM_FRAMES(ASanae);
BLINKING_ANIM_FRAMES(TSanae);

BLINKING_ANIM_FRAMES(CKanako);
BLINKING_ANIM_FRAMES(Kanako);
BLINKING_ANIM_FRAMES(AKanako);
BLINKING_ANIM_FRAMES(DKanako);

BLINKING_ANIM_FRAMES(CSuwako);
BLINKING_ANIM_FRAMES(Suwako);
BLINKING_ANIM_FRAMES(ASuwako);
BLINKING_ANIM_FRAMES(DSuwako);

BLINKING_ANIM_FRAMES(CKisume);
BLINKING_ANIM_FRAMES(Kisume);
BLINKING_ANIM_FRAMES(TKisume);

BLINKING_ANIM_FRAMES(CYamame);
BLINKING_ANIM_FRAMES(Yamame);
BLINKING_ANIM_FRAMES(SYamame);
BLINKING_ANIM_FRAMES(TYamame);

BLINKING_ANIM_FRAMES(CParsee);
BLINKING_ANIM_FRAMES(Parsee);
BLINKING_ANIM_FRAMES(DParsee);
BLINKING_ANIM_FRAMES(TParsee);

BLINKING_ANIM_FRAMES(CYuugi);
BLINKING_ANIM_FRAMES(Yuugi);
BLINKING_ANIM_FRAMES(AYuugi);
BLINKING_ANIM_FRAMES(DYuugi);

BLINKING_ANIM_FRAMES(CRin);
BLINKING_ANIM_FRAMES(Rin);
BLINKING_ANIM_FRAMES(ARin);
BLINKING_ANIM_FRAMES(SRin);

BLINKING_ANIM_FRAMES(ZFairy);

BLINKING_ANIM_FRAMES(CUtsuho);
BLINKING_ANIM_FRAMES(Utsuho);
BLINKING_ANIM_FRAMES(AUtsuho);
BLINKING_ANIM_FRAMES(SUtsuho);

BLINKING_ANIM_FRAMES(CSatori);
BLINKING_ANIM_FRAMES(Satori);
BLINKING_ANIM_FRAMES(DSatori);
BLINKING_ANIM_FRAMES(TSatori);

BLINKING_ANIM_FRAMES(CKoishi);
BLINKING_ANIM_FRAMES(Koishi);
BLINKING_ANIM_FRAMES(AKoishi);
BLINKING_ANIM_FRAMES(SKoishi);

BLINKING_ANIM_FRAMES(CNazrin);
BLINKING_ANIM_FRAMES(Nazrin);
BLINKING_ANIM_FRAMES(TNazrin);
BLINKING_ANIM_FRAMES(HNazrin);

BLINKING_ANIM_FRAMES(CKogasa);
BLINKING_ANIM_FRAMES(Kogasa);
BLINKING_ANIM_FRAMES(SKogasa);
BLINKING_ANIM_FRAMES(TKogasa);

BLINKING_ANIM_FRAMES(CIchirin);
BLINKING_ANIM_FRAMES(Ichirin);
BLINKING_ANIM_FRAMES(DIchirin);
BLINKING_ANIM_FRAMES(TIchirin);

BLINKING_ANIM_FRAMES(CMurasa);
BLINKING_ANIM_FRAMES(Murasa);
BLINKING_ANIM_FRAMES(AMurasa);
BLINKING_ANIM_FRAMES(DMurasa);

BLINKING_ANIM_FRAMES(CShou);
BLINKING_ANIM_FRAMES(Shou);
BLINKING_ANIM_FRAMES(AShou);
BLINKING_ANIM_FRAMES(TShou);

BLINKING_ANIM_FRAMES(CByakuren);
BLINKING_ANIM_FRAMES(Byakuren);
BLINKING_ANIM_FRAMES(DByakuren);
BLINKING_ANIM_FRAMES(TByakuren);

BLINKING_ANIM_FRAMES(CNue);
BLINKING_ANIM_FRAMES(Nue);
BLINKING_ANIM_FRAMES(ANue);
BLINKING_ANIM_FRAMES(TNue);

BLINKING_ANIM_FRAMES(CKyouko);
BLINKING_ANIM_FRAMES(Kyouko);

BLINKING_ANIM_FRAMES(CYoshika);
BLINKING_ANIM_FRAMES(Yoshika);

BLINKING_ANIM_FRAMES(CSeiga);
BLINKING_ANIM_FRAMES(Seiga);

BLINKING_ANIM_FRAMES(CTojiko);
BLINKING_ANIM_FRAMES(Tojiko);

BLINKING_ANIM_FRAMES(CFuto);
BLINKING_ANIM_FRAMES(Futo);

BLINKING_ANIM_FRAMES(CMiko);
BLINKING_ANIM_FRAMES(Miko);

BLINKING_ANIM_FRAMES(CMamizou);
BLINKING_ANIM_FRAMES(Mamizou);

BLINKING_ANIM_FRAMES(CSekibanki);
BLINKING_ANIM_FRAMES(Sekibanki);

BLINKING_ANIM_FRAMES(CKagerou);
BLINKING_ANIM_FRAMES(Kagerou);

BLINKING_ANIM_FRAMES(CWakasagihime);
BLINKING_ANIM_FRAMES(Wakasagihime);
BLINKING_ANIM_FRAMES(DWakasagihime);

BLINKING_ANIM_FRAMES(CWakasagihimeGolden);
BLINKING_ANIM_FRAMES(WakasagihimeGolden);
BLINKING_ANIM_FRAMES(DWakasagihimeGolden);

BLINKING_ANIM_FRAMES(CBenben);
BLINKING_ANIM_FRAMES(Benben);

BLINKING_ANIM_FRAMES(CYatsuhashi);
BLINKING_ANIM_FRAMES(Yatsuhashi);

BLINKING_ANIM_FRAMES(CRaiko);
BLINKING_ANIM_FRAMES(Raiko);

BLINKING_ANIM_FRAMES(CSeija);
BLINKING_ANIM_FRAMES(Seija);

BLINKING_ANIM_FRAMES(CShinmyoumaru);
BLINKING_ANIM_FRAMES(Shinmyoumaru);
BLINKING_ANIM_FRAMES(AShinmyoumaru);
BLINKING_ANIM_FRAMES(DShinmyoumaru);

BLINKING_ANIM_FRAMES(CSuika);
BLINKING_ANIM_FRAMES(Suika);
BLINKING_ANIM_FRAMES(ASuika);
BLINKING_ANIM_FRAMES(TSuika);

BLINKING_ANIM_FRAMES(CIku);
BLINKING_ANIM_FRAMES(Iku);
BLINKING_ANIM_FRAMES(DIku);
BLINKING_ANIM_FRAMES(TIku);

BLINKING_ANIM_FRAMES(CTenshi);
BLINKING_ANIM_FRAMES(Tenshi);
BLINKING_ANIM_FRAMES(ATenshi);
BLINKING_ANIM_FRAMES(DTenshi);

BLINKING_ANIM_FRAMES(CHatate);
BLINKING_ANIM_FRAMES(Hatate);
BLINKING_ANIM_FRAMES(DHatate);
BLINKING_ANIM_FRAMES(THatate);

BLINKING_ANIM_FRAMES(CSunny);
BLINKING_ANIM_FRAMES(Sunny);
BLINKING_ANIM_FRAMES(ASunny);
BLINKING_ANIM_FRAMES(DSunny);

BLINKING_ANIM_FRAMES(CLuna);
BLINKING_ANIM_FRAMES(Luna);
BLINKING_ANIM_FRAMES(ALuna);
BLINKING_ANIM_FRAMES(TLuna);

BLINKING_ANIM_FRAMES(CStar);
BLINKING_ANIM_FRAMES(Star);
BLINKING_ANIM_FRAMES(AStar);
BLINKING_ANIM_FRAMES(HStar);

BLINKING_ANIM_FRAMES(CKokoro);
BLINKING_ANIM_FRAMES(Kokoro);
BLINKING_ANIM_FRAMES(AKokoro);
BLINKING_ANIM_FRAMES(TKokoro);

BLINKING_ANIM_FRAMES(CKasen);
BLINKING_ANIM_FRAMES(Kasen);
BLINKING_ANIM_FRAMES(AKasen);

BLINKING_ANIM_FRAMES(CYorihime);
BLINKING_ANIM_FRAMES(Yorihime);
BLINKING_ANIM_FRAMES(SYorihime);

BLINKING_ANIM_FRAMES(CToyohime);
BLINKING_ANIM_FRAMES(Toyohime);
BLINKING_ANIM_FRAMES(TToyohime);

BLINKING_ANIM_FRAMES(CTokiko);
BLINKING_ANIM_FRAMES(Tokiko);
BLINKING_ANIM_FRAMES(ATokiko);

BLINKING_ANIM_FRAMES(CKosuzu);
BLINKING_ANIM_FRAMES(Kosuzu);

BLINKING_ANIM_FRAMES(CHakurei);
BLINKING_ANIM_FRAMES(Hakurei);

BLINKING_ANIM_FRAMES(CKirisame);
BLINKING_ANIM_FRAMES(Kirisame);

BLINKING_ANIM_FRAMES(Genji);

BLINKING_ANIM_FRAMES(CRika);
BLINKING_ANIM_FRAMES(Rika);

BLINKING_ANIM_FRAMES(CMeira);
BLINKING_ANIM_FRAMES(Meira);

BLINKING_ANIM_FRAMES(CEllen);
BLINKING_ANIM_FRAMES(Ellen);

BLINKING_ANIM_FRAMES(CKotohime);
BLINKING_ANIM_FRAMES(Kotohime);

BLINKING_ANIM_FRAMES(CKana);
BLINKING_ANIM_FRAMES(Kana);

BLINKING_ANIM_FRAMES(CRikako);
BLINKING_ANIM_FRAMES(Rikako);

BLINKING_ANIM_FRAMES(CChiyuri);
BLINKING_ANIM_FRAMES(Chiyuri);

BLINKING_ANIM_FRAMES(CYumemi);
BLINKING_ANIM_FRAMES(Yumemi);

BLINKING_ANIM_FRAMES(Kedama);
BLINKING_ANIM_FRAMES(Ruukoto);
BLINKING_ANIM_FRAMES(Mimichan);

BLINKING_ANIM_FRAMES(COrange);
BLINKING_ANIM_FRAMES(Orange);

BLINKING_ANIM_FRAMES(CKurumi);
BLINKING_ANIM_FRAMES(Kurumi);

BLINKING_ANIM_FRAMES(CElly);
BLINKING_ANIM_FRAMES(Elly);

BLINKING_ANIM_FRAMES(CKazami);
BLINKING_ANIM_FRAMES(Kazami);
BLINKING_ANIM_FRAMES(AKazami);

BLINKING_ANIM_FRAMES(CMugetsu);
BLINKING_ANIM_FRAMES(Mugetsu);

BLINKING_ANIM_FRAMES(CGengetsu);
BLINKING_ANIM_FRAMES(Gengetsu);

BLINKING_ANIM_FRAMES(CSara);
BLINKING_ANIM_FRAMES(Sara);

BLINKING_ANIM_FRAMES(CLouise);
BLINKING_ANIM_FRAMES(Louise);

BLINKING_ANIM_FRAMES(CMargatroid);
BLINKING_ANIM_FRAMES(Margatroid);

BLINKING_ANIM_FRAMES(CYuki);
BLINKING_ANIM_FRAMES(Yuki);

BLINKING_ANIM_FRAMES(CMai);
BLINKING_ANIM_FRAMES(Mai);

BLINKING_ANIM_FRAMES(CYumeko);
BLINKING_ANIM_FRAMES(Yumeko);

BLINKING_ANIM_FRAMES(CShinki);
BLINKING_ANIM_FRAMES(Shinki);

BLINKING_ANIM_FRAMES(Akyuu);

BLINKING_ANIM_FRAMES(Rinnosuke);

BLINKING_ANIM_FRAMES(CAmelia);
BLINKING_ANIM_FRAMES(Amelia);
BLINKING_ANIM_FRAMES(HAmelia);
BLINKING_ANIM_FRAMES(TAmelia);

BLINKING_ANIM_FRAMES(CBijou);
BLINKING_ANIM_FRAMES(Bijou);

BLINKING_ANIM_FRAMES(CSeiran);
BLINKING_ANIM_FRAMES(Seiran);
BLINKING_ANIM_FRAMES(ASeiran);

BLINKING_ANIM_FRAMES(CRingo);
BLINKING_ANIM_FRAMES(Ringo);
BLINKING_ANIM_FRAMES(HRingo);

BLINKING_ANIM_FRAMES(CClownpiece);
...
SINGLE_ANIMATION(CYoumuOld);
SINGLE_ANIMATION(YoumuOld);
SINGLE_ANIMATION(EYoumuOld);
...
SINGLE_ANIMATION(CShizuhaSannian);
SINGLE_ANIMATION(ShizuhaSannian);
...
SINGLE_ANIMATION(CMinorikoSannian);
SINGLE_ANIMATION(MinorikoSannian);
...
SINGLE_ANIMATION(DWakasagihime);

SINGLE_ANIMATION(CWakasagihimeGolden);
SINGLE_ANIMATION(WakasagihimeGolden);
SINGLE_ANIMATION(DWakasagihimeGolden);
...
SINGLE_ANIMATION(AShinmyoumaru);
SINGLE_ANIMATION(DShinmyoumaru);
...
SINGLE_ANIMATION(CSunny);
SINGLE_ANIMATION(Sunny);
SINGLE_ANIMATION(ASunny);
SINGLE_ANIMATION(DSunny);

SINGLE_ANIMATION(CLuna);
SINGLE_ANIMATION(Luna);
SINGLE_ANIMATION(ALuna);
SINGLE_ANIMATION(TLuna);

SINGLE_ANIMATION(CStar);
SINGLE_ANIMATION(Star);
SINGLE_ANIMATION(AStar);
SINGLE_ANIMATION(HStar);

SINGLE_ANIMATION(CKokoro);
SINGLE_ANIMATION(Kokoro);
SINGLE_ANIMATION(AKokoro);
SINGLE_ANIMATION(TKokoro);

SINGLE_ANIMATION(CKasen);
SINGLE_ANIMATION(Kasen);
SINGLE_ANIMATION(AKasen);
...
SINGLE_ANIMATION(CLouise);
SINGLE_ANIMATION(Louise);

SINGLE_ANIMATION(CMargatroid);
...
SINGLE_ANIMATION(CAmelia);
SINGLE_ANIMATION(Amelia);
SINGLE_ANIMATION(HAmelia);
SINGLE_ANIMATION(TAmelia);

SINGLE_ANIMATION(CBijou);
SINGLE_ANIMATION(Bijou);

SINGLE_ANIMATION(CSeiran);
SINGLE_ANIMATION(Seiran);
SINGLE_ANIMATION(ASeiran);

SINGLE_ANIMATION(CRingo);
SINGLE_ANIMATION(Ringo);
SINGLE_ANIMATION(HRingo);
