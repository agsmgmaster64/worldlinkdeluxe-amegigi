...
{   // Gen 1
    ...
    [SPECIES_CHIBI_REIMU]                    = sAnims_Bulbasaur,
    [SPECIES_NORMAL_REIMU]                   = sAnims_Ivysaur,
    [SPECIES_ATTACK_REIMU]                   = sAnims_Venusaur,
    [SPECIES_DEFENSE_REIMU]                  = sAnims_Charmander,
    [SPECIES_CHIBI_MARISA]                   = sAnims_Charmeleon,
    [SPECIES_NORMAL_MARISA]                  = sAnims_Charizard,
    [SPECIES_ATTACK_MARISA]                  = sAnims_Squirtle,
    [SPECIES_SPEED_MARISA]                   = sAnims_Wartortle,
    [SPECIES_CHIBI_DAIYOUSEI]                = sAnims_Blastoise,
    [SPECIES_NORMAL_DAIYOUSEI]               = sAnims_Caterpie,
    [SPECIES_ATTACK_DAIYOUSEI]               = sAnims_Metapod,
    [SPECIES_DEFENSE_DAIYOUSEI]              = sAnims_Butterfree,
    [SPECIES_CHIBI_CIRNO]                         = sAnims_Weedle,
    [SPECIES_NORMAL_CIRNO]                         = sAnims_Kakuna,
    [SPECIES_SPEED_CIRNO]                       = sAnims_Beedrill,
    [SPECIES_TECH_CIRNO]                         = sAnims_Pidgey,
    [SPECIES_CHIBI_RUMIA]                      = sAnims_Pidgeotto,
    [SPECIES_NORMAL_RUMIA]                        = sAnims_Pidgeot,
    [SPECIES_ATTACK_RUMIA]                        = sAnims_Rattata,
    [SPECIES_SPEED_RUMIA]                       = sAnims_Raticate,
    [SPECIES_CHIBI_MEILING]                        = sAnims_Spearow,
    [SPECIES_NORMAL_MEILING]                         = sAnims_Fearow,
    [SPECIES_DEFENSE_MEILING]                          = sAnims_Ekans,
    [SPECIES_SPEED_MEILING]                          = sAnims_Arbok,
    [SPECIES_CHIBI_KOAKUMA]                        = sAnims_Pikachu,
    [SPECIES_NORMAL_KOAKUMA]                         = sAnims_Raichu,
    [SPECIES_HELPER_KOAKUMA]                      = sAnims_Sandshrew,
    [SPECIES_PLCEHOLDER1_KOAKUMA]                      = sAnims_Sandslash,
    [SPECIES_CHIBI_PATCHOULI]                      = sAnims_NidoranF,
    [SPECIES_NORMAL_PATCHOULI]                       = sAnims_Nidorina,
    [SPECIES_ATTACK_PATCHOULI]                      = sAnims_Nidoqueen,
    [SPECIES_DEFENSE_PATCHOULI]                      = sAnims_NidoranM,
    ...
    [SPECIES_CHIBI_REISEN]                         = sAnims_Seadra,
    [SPECIES_NORMAL_REISEN]                        = sAnims_Goldeen,
    [SPECIES_DEFENSE_REISEN]                        = sAnims_Seaking,
    [SPECIES_TECH_REISEN]                         = sAnims_Staryu,
