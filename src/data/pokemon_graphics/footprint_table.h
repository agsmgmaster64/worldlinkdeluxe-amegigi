const u8 *const gMonFootprintTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_CHIBI_REIMU] = gMonFootprint_Bulbasaur,
    [SPECIES_NORMAL_REIMU] = gMonFootprint_Ivysaur,
    [SPECIES_ATTACK_REIMU] = gMonFootprint_Venusaur,
    [SPECIES_DEFENSE_REIMU] = gMonFootprint_Charmander,
    [SPECIES_CHIBI_MARISA] = gMonFootprint_Charmeleon,
    [SPECIES_NORMAL_MARISA] = gMonFootprint_Charizard,
    [SPECIES_ATTACK_MARISA] = gMonFootprint_Squirtle,
    [SPECIES_SPEED_MARISA] = gMonFootprint_Wartortle,
    [SPECIES_CHIBI_DAIYOUSEI] = gMonFootprint_Blastoise,
    [SPECIES_NORMAL_DAIYOUSEI] = gMonFootprint_Caterpie,
    [SPECIES_ATTACK_DAIYOUSEI] = gMonFootprint_Metapod,
    [SPECIES_DEFENSE_DAIYOUSEI] = gMonFootprint_Butterfree,
    [SPECIES_CHIBI_CIRNO] = gMonFootprint_Weedle,
    [SPECIES_NORMAL_CIRNO] = gMonFootprint_Kakuna,
    [SPECIES_SPEED_CIRNO] = gMonFootprint_Beedrill,
    [SPECIES_TECH_CIRNO] = gMonFootprint_Pidgey,
    [SPECIES_CHIBI_RUMIA] = gMonFootprint_Pidgeotto,
    [SPECIES_NORMAL_RUMIA] = gMonFootprint_Pidgeot,
    [SPECIES_ATTACK_RUMIA] = gMonFootprint_Rattata,
    [SPECIES_SPEED_RUMIA] = gMonFootprint_Raticate,
    [SPECIES_CHIBI_MEILING] = gMonFootprint_Spearow,
    [SPECIES_NORMAL_MEILING] = gMonFootprint_Fearow,
    [SPECIES_DEFENSE_MEILING] = gMonFootprint_Ekans,
    [SPECIES_SPEED_MEILING] = gMonFootprint_Arbok,
    [SPECIES_CHIBI_KOAKUMA] = gMonFootprint_Pikachu,
    [SPECIES_NORMAL_KOAKUMA] = gMonFootprint_Raichu,
    [SPECIES_HELPER_KOAKUMA] = gMonFootprint_Sandshrew,
    [SPECIES_PLCEHOLDER1_KOAKUMA] = gMonFootprint_Sandslash,
    [SPECIES_CHIBI_PATCHOULI] = gMonFootprint_NidoranF,
    [SPECIES_NORMAL_PATCHOULI] = gMonFootprint_Nidorina,
    [SPECIES_ATTACK_PATCHOULI] = gMonFootprint_Nidoqueen,
    [SPECIES_DEFENSE_PATCHOULI] = gMonFootprint_NidoranM,
    ...
    [SPECIES_CHIBI_YOUMU] = gMonFootprint_THYoumu1,
    [SPECIES_NORMAL_YOUMU] = gMonFootprint_THYoumu2N,
    [SPECIES_DEFENSE_YOUMU] = gMonFootprint_THYoumu2D,
    [SPECIES_SPEED_YOUMU] = gMonFootprint_THYoumu2S,
    ...
    [SPECIES_CHIBI_REISEN] = gMonFootprint_Seadra,
    [SPECIES_NORMAL_REISEN] = gMonFootprint_Goldeen,
    [SPECIES_DEFENSE_REISEN] = gMonFootprint_Seaking,
    [SPECIES_TECH_REISEN] = gMonFootprint_Staryu,
