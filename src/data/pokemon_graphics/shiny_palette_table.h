const struct CompressedSpritePalette gMonShinyPaletteTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SHINY_PAL(CHIBI_REIMU, gMonShinyPalette_Bulbasaur),
    SPECIES_SHINY_PAL(NORMAL_REIMU, gMonShinyPalette_Ivysaur),
    SPECIES_SHINY_PAL(ATTACK_REIMU, gMonShinyPalette_Venusaur),
    SPECIES_SHINY_PAL(DEFENSE_REIMU, gMonShinyPalette_Charmander),
    SPECIES_SHINY_PAL(CHIBI_MARISA, gMonShinyPalette_Charmeleon),
    SPECIES_SHINY_PAL(NORMAL_MARISA, gMonShinyPalette_Charizard),
    SPECIES_SHINY_PAL(ATTACK_MARISA, gMonShinyPalette_Squirtle),
    SPECIES_SHINY_PAL(SPEED_MARISA, gMonShinyPalette_Wartortle),
    SPECIES_SHINY_PAL(CHIBI_DAIYOUSEI, gMonShinyPalette_Blastoise),
    SPECIES_SHINY_PAL(NORMAL_DAIYOUSEI, gMonShinyPalette_Caterpie),
    SPECIES_SHINY_PAL(ATTACK_DAIYOUSEI, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(DEFENSE_DAIYOUSEI, gMonShinyPalette_Butterfree),
    SPECIES_SHINY_PAL(CHIBI_CIRNO, gMonShinyPalette_Weedle),
    SPECIES_SHINY_PAL(NORMAL_CIRNO, gMonShinyPalette_Kakuna),
    SPECIES_SHINY_PAL(SPEED_CIRNO, gMonShinyPalette_Beedrill),
    SPECIES_SHINY_PAL(TECH_CIRNO, gMonShinyPalette_Pidgey),
    SPECIES_SHINY_PAL(CHIBI_RUMIA, gMonShinyPalette_Pidgeotto),
    SPECIES_SHINY_PAL(NORMAL_RUMIA, gMonShinyPalette_Pidgeot),
    SPECIES_SHINY_PAL(ATTACK_RUMIA, gMonShinyPalette_Rattata),
    SPECIES_SHINY_PAL(SPEED_RUMIA, gMonShinyPalette_Raticate),
    SPECIES_SHINY_PAL(CHIBI_MEILING, gMonShinyPalette_Spearow),
    SPECIES_SHINY_PAL(NORMAL_MEILING, gMonShinyPalette_Fearow),
    SPECIES_SHINY_PAL(DEFENSE_MEILING, gMonShinyPalette_Ekans),
    SPECIES_SHINY_PAL(SPEED_MEILING, gMonShinyPalette_Arbok),
    SPECIES_SHINY_PAL(CHIBI_KOAKUMA, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(NORMAL_KOAKUMA, gMonShinyPalette_Raichu),
    SPECIES_SHINY_PAL(HELPER_KOAKUMA, gMonShinyPalette_Sandshrew),
    SPECIES_SHINY_PAL(PLCEHOLDER1_KOAKUMA, gMonShinyPalette_Sandslash),
    SPECIES_SHINY_PAL(CHIBI_PATCHOULI, gMonShinyPalette_NidoranF),
    SPECIES_SHINY_PAL(NORMAL_PATCHOULI, gMonShinyPalette_Nidorina),
    SPECIES_SHINY_PAL(ATTACK_PATCHOULI, gMonShinyPalette_Nidoqueen),
    SPECIES_SHINY_PAL(DEFENSE_PATCHOULI, gMonShinyPalette_NidoranM),
    ...
    SPECIES_SHINY_PAL(CHIBI_YOUMU, gMonShinyPalette_THYoumu1),
    SPECIES_SHINY_PAL(NORMAL_YOUMU, gMonShinyPalette_THYoumu2N),
    SPECIES_SHINY_PAL(DEFENSE_YOUMU, gMonShinyPalette_THYoumu2D),
    SPECIES_SHINY_PAL(SPEED_YOUMU, gMonShinyPalette_THYoumu2S),
    ...
    SPECIES_SHINY_PAL(CHIBI_REISEN, gMonShinyPalette_Seadra),
    SPECIES_SHINY_PAL(NORMAL_REISEN, gMonShinyPalette_Goldeen),
    SPECIES_SHINY_PAL(DEFENSE_REISEN, gMonShinyPalette_Seaking),
    SPECIES_SHINY_PAL(TECH_REISEN, gMonShinyPalette_Staryu),
