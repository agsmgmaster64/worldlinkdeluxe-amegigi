const struct CompressedSpriteSheet gMonBackPicTable[NUM_SPECIES + 1] =
{
    ...
    SPECIES_SPRITE(CHIBI_REIMU, gMonBackPic_Bulbasaur),
    SPECIES_SPRITE(NORMAL_REIMU, gMonBackPic_Ivysaur),
    SPECIES_SPRITE(ATTACK_REIMU, gMonBackPic_Venusaur),
    SPECIES_SPRITE(DEFENSE_REIMU, gMonBackPic_Charmander),
    SPECIES_SPRITE(CHIBI_MARISA, gMonBackPic_Charmeleon),
    SPECIES_SPRITE(NORMAL_MARISA, gMonBackPic_Charizard),
    SPECIES_SPRITE(ATTACK_MARISA, gMonBackPic_Squirtle),
    SPECIES_SPRITE(SPEED_MARISA, gMonBackPic_Wartortle),
    SPECIES_SPRITE(CHIBI_DAIYOUSEI, gMonBackPic_Blastoise),
    SPECIES_SPRITE(NORMAL_DAIYOUSEI, gMonBackPic_Caterpie),
    SPECIES_SPRITE(ATTACK_DAIYOUSEI, gMonBackPic_Metapod),
    SPECIES_SPRITE(DEFENSE_DAIYOUSEI, gMonBackPic_Butterfree),
    SPECIES_SPRITE(CHIBI_CIRNO, gMonBackPic_Weedle),
    SPECIES_SPRITE(NORMAL_CIRNO, gMonBackPic_Kakuna),
    SPECIES_SPRITE(SPEED_CIRNO, gMonBackPic_Beedrill),
    SPECIES_SPRITE(TECH_CIRNO, gMonBackPic_Pidgey),
    SPECIES_SPRITE(CHIBI_RUMIA, gMonBackPic_Pidgeotto),
    SPECIES_SPRITE(NORMAL_RUMIA, gMonBackPic_Pidgeot),
    SPECIES_SPRITE(ATTACK_RUMIA, gMonBackPic_Rattata),
    SPECIES_SPRITE(SPEED_RUMIA, gMonBackPic_Raticate),
    SPECIES_SPRITE(CHIBI_MEILING, gMonBackPic_Spearow),
    SPECIES_SPRITE(NORMAL_MEILING, gMonBackPic_Fearow),
    SPECIES_SPRITE(DEFENSE_MEILING, gMonBackPic_Ekans),
    SPECIES_SPRITE(SPEED_MEILING, gMonBackPic_Arbok),
    SPECIES_SPRITE(CHIBI_KOAKUMA, gMonBackPic_Pikachu),
    SPECIES_SPRITE(NORMAL_KOAKUMA, gMonBackPic_Raichu),
    SPECIES_SPRITE(HELPER_KOAKUMA, gMonBackPic_Sandshrew),
    SPECIES_SPRITE(PLCEHOLDER1_KOAKUMA, gMonBackPic_Sandslash),
    SPECIES_SPRITE(CHIBI_PATCHOULI, gMonBackPic_NidoranF),
    SPECIES_SPRITE(NORMAL_PATCHOULI, gMonBackPic_Nidorina),
    SPECIES_SPRITE(ATTACK_PATCHOULI, gMonBackPic_Nidoqueen),
    SPECIES_SPRITE(DEFENSE_PATCHOULI, gMonBackPic_NidoranM),
    ...
    SPECIES_SPRITE(CHIBI_YOUMU, gMonBackPic_THYoumu1),
    SPECIES_SPRITE(NORMAL_YOUMU, gMonBackPic_THYoumu2N),
    SPECIES_SPRITE(DEFENSE_YOUMU, gMonBackPic_THYoumu2D),
    SPECIES_SPRITE(SPEED_YOUMU, gMonBackPic_THYoumu2S),
    ...
    SPECIES_SPRITE(CHIBI_REISEN, gMonBackPic_Seadra),
    SPECIES_SPRITE(NORMAL_REISEN, gMonBackPic_Goldeen),
    SPECIES_SPRITE(DEFENSE_REISEN, gMonBackPic_Seaking),
    SPECIES_SPRITE(TECH_REISEN, gMonBackPic_Staryu),
