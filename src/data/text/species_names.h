const u8 gSpeciesNames[NUM_SPECIES][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_CHIBI_CIRNO] = _("Weedle"),
    [SPECIES_NORMAL_CIRNO] = _("Kakuna"),
    [SPECIES_SPEED_CIRNO] = _("Beedrill"),
    [SPECIES_TECH_CIRNO] = _("TCirno"),
    [SPECIES_CHIBI_RUMIA] = _("Pidgeotto"),
    [SPECIES_NORMAL_RUMIA] = _("Pidgeot"),
    [SPECIES_ATTACK_RUMIA] = _("Rattata"),
    [SPECIES_SPEED_RUMIA] = _("SRumia"),
    [SPECIES_CHIBI_MEILING] = _("Spearow"),
    [SPECIES_NORMAL_MEILING] = _("Fearow"),
    [SPECIES_DEFENSE_MEILING] = _("Ekans"),
    [SPECIES_SPEED_MEILING] = _("SMeiling"),
    [SPECIES_CHIBI_KOAKUMA] = _("Pikachu"),
    [SPECIES_NORMAL_KOAKUMA] = _("Raichu"),
    [SPECIES_HELPER_KOAKUMA] = _("HKoakuma"),
    [SPECIES_PLCEHOLDER1_KOAKUMA] = _("Sandslash"),
    [SPECIES_CHIBI_PATCHOULI] = _("Nidoran♀"),
    [SPECIES_NORMAL_PATCHOULI] = _("Nidorina"),
    [SPECIES_ATTACK_PATCHOULI] = _("Nidoqueen"),
