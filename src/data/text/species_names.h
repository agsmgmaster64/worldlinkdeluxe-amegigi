const u8 gSpeciesNames[NUM_SPECIES][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_CHIBI_REIMU] = _("Bulbasaur"),
    [SPECIES_NORMAL_REIMU] = _("Ivysaur"),
    [SPECIES_ATTACK_REIMU] = _("Venusaur"),
    [SPECIES_DEFENSE_REIMU] = _("Charmander"),
    [SPECIES_CHIBI_MARISA] = _("CMarisa"),
    [SPECIES_NORMAL_MARISA] = _("Marisa"),
    [SPECIES_ATTACK_MARISA] = _("AMarisa"),
    [SPECIES_SPEED_MARISA] = _("SMarisa"),
    [SPECIES_CHIBI_DAIYOUSEI] = _("CDaiyousei"),
    [SPECIES_NORMAL_DAIYOUSEI] = _("Daiyousei"),
    [SPECIES_ATTACK_DAIYOUSEI] = _("ADaiyousei"),
    [SPECIES_DEFENSE_DAIYOUSEI] = _("DDaiyousei"),
    [SPECIES_CHIBI_CIRNO] = _("CCirno"),
    [SPECIES_NORMAL_CIRNO] = _("Cirno"),
    [SPECIES_SPEED_CIRNO] = _("SCirno"),
    [SPECIES_TECH_CIRNO] = _("TCirno"),
    [SPECIES_CHIBI_RUMIA] = _("CRumia"),
    [SPECIES_NORMAL_RUMIA] = _("Rumia"),
    [SPECIES_ATTACK_RUMIA] = _("ARumia"),
    [SPECIES_SPEED_RUMIA] = _("SRumia"),
    [SPECIES_CHIBI_MEILING] = _("CMeiling"),
    [SPECIES_NORMAL_MEILING] = _("Meiling"),
    [SPECIES_DEFENSE_MEILING] = _("DMeiling"),
    [SPECIES_SPEED_MEILING] = _("SMeiling"),
    [SPECIES_CHIBI_KOAKUMA] = _("CKoakuma"),
    [SPECIES_NORMAL_KOAKUMA] = _("Koakuma"),
    [SPECIES_HELPER_KOAKUMA] = _("HKoakuma"),
    [SPECIES_PLCEHOLDER1_KOAKUMA] = _("Sandslash"),
    [SPECIES_CHIBI_PATCHOULI] = _("CPatchouli"),
    [SPECIES_NORMAL_PATCHOULI] = _("Patchouli"),
    [SPECIES_ATTACK_PATCHOULI] = _("APatchouli"),
    [SPECIES_DEFENSE_PATCHOULI] = _("DPatchouli"),
    [SPECIES_NIDORINO] = _("CSakuya"),
    [SPECIES_NIDOKING] = _("Sakuya"),
    [SPECIES_CLEFAIRY] = _("Clefairy"),
    [SPECIES_CLEFABLE] = _("HSakuya"),
    [SPECIES_VULPIX] = _("CRemilia"),
    [SPECIES_NINETALES] = _("Remilia"),
    [SPECIES_JIGGLYPUFF] = _("ARemilia"),
    [SPECIES_WIGGLYTUFF] = _("DRemilia"),
    [SPECIES_ZUBAT] = _("CFlandre"),
    [SPECIES_GOLBAT] = _("Flandre"),
    [SPECIES_ODDISH] = _("Oddish"),
    [SPECIES_GLOOM] = _("SFlandre"),
    [SPECIES_VILEPLUME] = _("CLetty"),
    [SPECIES_PARAS] = _("Letty"),
    [SPECIES_PARASECT] = _("Parasect"),
    [SPECIES_VENONAT] = _("HLetty"),
    [SPECIES_VENOMOTH] = _("Shanghai"),
    [SPECIES_DIGLETT] = _("Hourai"),
    [SPECIES_DUGTRIO] = _("CAlice"),
    [SPECIES_MEOWTH] = _("Alice"),
    [SPECIES_PERSIAN] = _("Persian"),
    [SPECIES_PSYDUCK] = _("Psyduck"),
    [SPECIES_GOLDUCK] = _("TAlice"),
    [SPECIES_MANKEY] = _("CLilyWhite"),
    [SPECIES_PRIMEAPE] = _("LilyWhite"),
    [SPECIES_GROWLITHE] = _("Growlithe"),
    [SPECIES_ARCANINE] = _("HLilyWhite"),
    [SPECIES_POLIWAG] = _("CLilyBlack"),
    [SPECIES_POLIWHIRL] = _("LilyBlack"),
    [SPECIES_POLIWRATH] = _("Poliwrath"),
    [SPECIES_ABRA] = _("SLilyBlack"),
    [SPECIES_KADABRA] = _("CLunasa"),
    [SPECIES_ALAKAZAM] = _("Lunasa"),
    [SPECIES_MACHOP] = _("HLunasa"),
    [SPECIES_MACHOKE] = _("PLunasa"),
    [SPECIES_MACHAMP] = _("CMerlin"),
    [SPECIES_BELLSPROUT] = _("Merlin"),
    [SPECIES_WEEPINBELL] = _("HMerlin"),
    [SPECIES_VICTREEBEL] = _("PMerlin"),
    [SPECIES_TENTACOOL] = _("CLyrica"),
    [SPECIES_TENTACRUEL] = _("Lyrica"),
    [SPECIES_GEODUDE] = _("HLyrica"),
    [SPECIES_GRAVELER] = _("PLyrica"),
    [SPECIES_GOLEM] = _("CLayla"),
    [SPECIES_PONYTA] = _("Layla"),
    [SPECIES_RAPIDASH] = _("DLayla"),
    [SPECIES_SLOWPOKE] = _("PLayla"),
    [SPECIES_CHIBI_YOUMU] = _("CYoumu"),
    [SPECIES_NORMAL_YOUMU] = _("Youmu"),
    [SPECIES_DEFENSE_YOUMU] = _("DYoumu"),
    [SPECIES_SPEED_YOUMU] = _("SYoumu"),
    [SPECIES_DODUO] = _("Doduo"),
    [SPECIES_DODRIO] = _("Dodrio"),
    [SPECIES_SEEL] = _("Seel"),
    [SPECIES_DEWGONG] = _("DYuyuko"),
    [SPECIES_GRIMER] = _("CChen"),
    [SPECIES_MUK] = _("Chen"),
    [SPECIES_SHELLDER] = _("AChen"),
    [SPECIES_CLOYSTER] = _("TChen"),
    [SPECIES_GASTLY] = _("CRan"),
    [SPECIES_HAUNTER] = _("Ran"),
    [SPECIES_GENGAR] = _("ARan"),
    [SPECIES_ONIX] = _("HRan"),
    [SPECIES_DROWZEE] = _("CYukari"),
    [SPECIES_HYPNO] = _("Yukari"),
    [SPECIES_KRABBY] = _("DYukari"),
    [SPECIES_KINGLER] = _("TYukari"),
    [SPECIES_VOLTORB] = _("CWriggle"),
    [SPECIES_ELECTRODE] = _("Wriggle"),
    [SPECIES_EXEGGCUTE] = _("DWriggle"),
    [SPECIES_EXEGGUTOR] = _("SWriggle"),
    [SPECIES_CUBONE] = _("CMystia"),
    [SPECIES_MAROWAK] = _("Mystia"),
    [SPECIES_HITMONLEE] = _("AMystia"),
    [SPECIES_HITMONCHAN] = _("HMystia"),
    [SPECIES_LICKITUNG] = _("CKeine"),
    [SPECIES_KOFFING] = _("Keine"),
    [SPECIES_WEEZING] = _("HKeine"),
    [SPECIES_RHYHORN] = _("AKeine"),
    [SPECIES_RHYDON] = _("DKeine"),
    [SPECIES_CHANSEY] = _("CTewi"),
    [SPECIES_TANGELA] = _("Tewi"),
    [SPECIES_KANGASKHAN] = _("ATewi"),
    [SPECIES_HORSEA] = _("DTewi"),
    [SPECIES_CHIBI_REISEN] = _("CReisen"),
    [SPECIES_NORMAL_REISEN] = _("Reisen"),
    [SPECIES_DEFENSE_REISEN] = _("DReisen"),
    [SPECIES_TECH_REISEN] = _("TReisen"),
