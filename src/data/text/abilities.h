...
static const u8 sIceBodyDescription[] = _("HP recovery in Hail.");
...
static const u8 sWellBakedBodyDescription[] = _("Nature moves can also burn.");
...
static const u8 sRockyPayloadDescription[] = _("Nature moves are Ice type.");
...
static const u8 sEarthEaterDescription[] = _("Turns nature into HP.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_HIGH_STRENGTH] = _("High Strength"),
    ...
    [ABILITY_MAGIC_BARRIER] = _("Magic Barrier"),
    ...
    [ABILITY_LEAF_SPICE] = _("Leaf Spice"),
    [ABILITY_WIND_RIDER] = _("Wind Rider"),
    [ABILITY_COLD_HEART] = _("Cold Heart"),
    [ABILITY_NATURE_FROST] = _("Nature Frost"),
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_OBLIVIOUS] = _("Oblivious"),
    [ABILITY_CLOUD_NINE] = _("Cloud Nine"),
    [ABILITY_FOCUS] = _("CompoundEyes"),
    [ABILITY_INSOMNIA] = _("Insomnia"),
    [ABILITY_MYSTERIOUS] = _("Color Change"),
    [ABILITY_IMMUNITY] = _("Immunity"),
    [ABILITY_FLASH_FIRE] = _("Flash Fire"),
    [ABILITY_ADVENT] = _("Advent"),
    [ABILITY_OWN_TEMPO] = _("Own Tempo"),
    ...
    [ABILITY_PLAY_GHOST] = _("Play Ghost"),
    [ABILITY_LEVITATE] = _("Levitate"),
    [ABILITY_INFECTIOUS] = _("Effect Spore"),
    [ABILITY_SYNCHRONIZE] = _("Synchronize"),
    [ABILITY_HAKUREI_MIKO] = _("Hakurei Miko"),
    [ABILITY_NATURAL_CURE] = _("Natural Cure"),
    ...
    [ABILITY_ARENA_TRAP] = _("Arena Trap"),
    [ABILITY_VITAL_SPIRIT] = _("Vital Spirit"),
    [ABILITY_MAGIC_BARRIER] = _("MagicBarrier"),
    [ABILITY_PURE_POWER] = _("Pure Power"),
    [ABILITY_SHELL_ARMOR] = _("Shell Armor"),
    [ABILITY_HISOUTEN] = _("Hisouten"),
    [ABILITY_TANGLED_FEET] = _("Tangled Feet"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_LEAF_SPICE] = sWellBakedBodyDescription,
    [ABILITY_WIND_RIDER] = sWindRiderDescription,
    [ABILITY_COLD_HEART] = sGuardDogDescription,
    [ABILITY_NATURE_FROST] = sRockyPayloadDescription,
    ...
    [ABILITY_UNWAVERING] = sOrichalcumPulseDescription,
    [ABILITY_FASCINATE] = sHadronEngineDescription,
    ...
    [ABILITY_FLORA_ABSORB] = sEarthEaterDescription,
