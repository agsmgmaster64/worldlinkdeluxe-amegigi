...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_BURN_POWDER - 1] = sBideDescription,
    ...
    [MOVE_TOXIC_GAS - 1] = sPoisonGasDescription,
    ...
    [MOVE_DECISION - 1] = sDragonBreathDescription,
    ...
    [MOVE_MULTI_PULSE - 1] = sHiddenPowerDescription,
    ...
    [MOVE_NATIVE_POWER - 1] = sNaturePowerDescription,
    ...
    [MOVE_MYSTIC_WATER - 1] = sAquaRingDescription,
    ...
    [MOVE_ENERGY_LIGHT - 1] = sEnergyBallDescription,
    ...
    [MOVE_BLADE_FLASH - 1] = sBulletPunchDescription,
    [MOVE_AVALANCHE - 1] = sRevengeDescription,
    [MOVE_ICE_SHARD - 1] = sIceShardDescription,
    [MOVE_SHADOW_HIT - 1] = sShadowClawDescription,
    ...
    [MOVE_DRAWN_LINE - 1] = sIronHeadDescription,
