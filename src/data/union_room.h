...
static const struct ListMenuItem sTradingBoardTypes[NUMBER_OF_MON_TYPES] = {
    ...
    { gTypesInfo[TYPE_REASON].name,   TYPE_REASON         },
    { gTypesInfo[TYPE_DREAM].name,    TYPE_DREAM          },
    { gTypesInfo[TYPE_MIASMA].name,   TYPE_MIASMA         },
