...
// Type-boosting Held Items
    ...
    [ITEM_BRIDAL_GOWN] =
    {
        ...
        .description = COMPOUND_STRING("A costume that\n"
                                       "boosts Illusion-\n"
                                       "type moves."),
        .pocket = POCKET_BATTLE_ITEMS,
        .type = ITEM_USE_BAG_MENU,
...
// Berries
    ...
    [ITEM_POMEG_BERRY] =
    {
        ...
        .price = (I_BERRY_PRICE >= GEN_8) ? 80 : 20,
        .description = COMPOUND_STRING("Makes a Puppet\n"
                                       "friendly but lowers\n"
                                       "base HP."),
        .pocket = POCKET_BERRIES,
        .type = ITEM_USE_PARTY_MENU,
...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM_MULTI_PULSE] =
    {
        .name = _("TM10"),
        .price = 3000,
        .description = COMPOUND_STRING("The move type\n"
                                       "varies based\n"
                                       "on the held item."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_SONIC_BOOM] =
    {
        .name = _("TM15"),
        .price = 7500,
        .description = COMPOUND_STRING("Launches shock\n"
                                       "waves that may\n"
                                       "reduce Sp. Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM_STEEL_FIST] =
    {
        .name = _("TM23"),
        .price = 3000,
        .description = COMPOUND_STRING("Attacks with an iron\n"
                                       "hard punch. It may\n"
                                       "lower Defense."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM52] =
    {
        .name = _("TM52"),
        .price = 3000,
        .description = COMPOUND_STRING("Launches a power\n"
                                       "ball that may\n"
                                       "lower Sp. Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM53] =
    {
        .name = _("TM53"),
        .price = 3000,
        .description = COMPOUND_STRING("Shines a ray of\n"
                                       "sunshine that may\n"
                                       "lower Sp. Def."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
    ...
    [ITEM_TM54] =
    {
        .name = _("TM54"),
        .price = 3000,
        .description = COMPOUND_STRING("This move will\n"
                                       "always leave the\n"
                                       "foe with 1 HP."),
        .importance = I_REUSABLE_TMS,
        .pocket = POCKET_TM_HM,
