const struct BattleMove gBattleMoves[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_BIND] =
    {
        #if B_UPDATED_TOUHOUMON_MOVE_DATA == WORLD_LINK_DELUXE
            .accuracy = 90,
    ...
    [MOVE_JUMP_KICK] =
    {
        #if (B_UPDATED_MOVE_DATA == GEN_4 || B_UPDATED_TOUHOUMON_MOVE_DATA == WORLD_LINK_DELUXE)
            .power = 85,
            .pp = 25,
        #elif B_UPDATED_MOVE_DATA >= GEN_5
            .power = 100,
    ...
    [MOVE_THRASH] =
    {
            ...
            .pp = 20,
        #endif
        .effect = EFFECT_HIT, // EFFECT_THRASH
        .type = TYPE_DARK,
        .accuracy = 100,
        .secondaryEffectChance = 100,
        .target = MOVE_TARGET_SELECTED,
