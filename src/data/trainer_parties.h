...
static const struct TrainerMon sParty_Olivia[] = {
    ...
    .moves = {MOVE_TAUNT, MOVE_GALE, MOVE_WATER_PULSE, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 39,
...
static const struct TrainerMon sParty_Walter3[] = {
    ...
    .lvl = 36,
    .species = SPECIES_NORMAL_TOJIKO,
    .moves = {MOVE_HEADBUTT, MOVE_SAND_ATTACK, MOVE_HEARTS_EYE, MOVE_FURY_SWIPES}
    },
    {
    .iv = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 36,
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_DECISION, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_DECISION, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 55,
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_GUN, MOVE_JAMMING, MOVE_PROTECT, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 31,
    ...
    .species = SPECIES_TECH_LUNA,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_DECISION, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .species = SPECIES_TECH_KOKORO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_GALE, MOVE_TAUNT, MOVE_LEER}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 46,
...
static const struct TrainerMon sParty_AnnaAndMeg1[] = {
    ...
    .lvl = 15,
    .species = SPECIES_CHIBI_TOJIKO,
    .moves = {MOVE_GROWL, MOVE_TAIL_WHIP, MOVE_HEADBUTT, MOVE_HEARTS_EYE}
    },
    {
    .lvl = 17,
    .species = SPECIES_MAKUHITA,
...
static const struct TrainerMon sParty_Aaron[] = {
    ...
    .lvl = 34,
    .species = SPECIES_NORMAL_RIKA,
    .moves = {MOVE_DECISION, MOVE_HEADBUTT, MOVE_FOCUS_ENERGY, MOVE_EMBER}
    }
};
...
static const struct TrainerMon sParty_Lao1[] = {
    ...
    .lvl = 17,
    .species = SPECIES_NORMAL_KEINE,
    .moves = {MOVE_TOXIC_GAS, MOVE_TACKLE, MOVE_SMOG, MOVE_SELF_DESTRUCT}
    },
    {
    .lvl = 17,
    .species = SPECIES_NORMAL_KEINE,
    ...
    .lvl = 17,
    .species = SPECIES_NORMAL_KEINE,
    .moves = {MOVE_TOXIC_GAS, MOVE_TACKLE, MOVE_SLUDGE, MOVE_SELF_DESTRUCT}
    }
};
...
static const struct TrainerMon sParty_Lao2[] = {
    ...
    .lvl = 24,
    .species = SPECIES_NORMAL_KEINE,
    .moves = {MOVE_TOXIC_GAS, MOVE_TACKLE, MOVE_SLUDGE, MOVE_NONE}
    },
    {
    .lvl = 24,
    .species = SPECIES_NORMAL_KEINE,
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .lvl = 44,
    .species = SPECIES_TECH_LUNA,
    .moves = {MOVE_AERIAL_ACE, MOVE_SAFEGUARD, MOVE_DECISION, MOVE_DRAGON_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 43,
    ...
    .lvl = 45,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_CALM_MIND, MOVE_MANA_BURST, MOVE_FUTURE_SIGHT}
    }
};
...
static const struct TrainerMon sParty_Hideo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_NORMAL_KEINE,
    .moves = {MOVE_TACKLE, MOVE_TOXIC_GAS, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMon sParty_Keigo[] = {
    ...
    .lvl = 28,
    .species = SPECIES_NORMAL_KEINE,
    .moves = {MOVE_TOXIC_GAS, MOVE_SELF_DESTRUCT, MOVE_SLUDGE, MOVE_SMOKESCREEN}
    },
    {
    .lvl = 28,
    .species = SPECIES_NINJASK,
...
static const struct TrainerMon sParty_Winona2[] = {
    ...
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_JAMMING, MOVE_PROTECT, MOVE_AERIAL_ACE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
...
static const struct TrainerMon sParty_Juan2[] = {
    ...
    .species = SPECIES_TECH_KOKORO,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_GALE, MOVE_TAUNT, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
