const struct BattleFrontierTrainer gBattleFrontierTrainers[FRONTIER_TRAINERS_COUNT] =
{
    ...
    [FRONTIER_TRAINER_ANTON] = {
        ...
        .speechLose = {EC_WORD_IT_S, EC_WORD_A, EC_WORD_TOUGH, EC_WORD_LOSS, EC_WORD_TO, EC_MOVE2(SHADOW_DANCE)},
    ...
    [FRONTIER_TRAINER_DARYL] = {
        ...
        .trainerName = _("DARYL"),
        .speechBefore = {EC_WORD_I, EC_WORD_ONLY, EC_WORD_KNOW, EC_WORD_HOW, EC_WORD_TO, EC_MOVE(BATTERY_CHARGE)},
    ...
    [FRONTIER_TRAINER_GRIFFEN] = {
        ...
        .speechBefore = {EC_WORD_I, EC_MOVE2(SHADOW_DANCE), EC_MOVE2(SLUDGE), EC_WORD_TO, EC_MOVE2(TRANSFORM), EC_WORD_MYSELF},
    ...
    [FRONTIER_TRAINER_BRODY] = {
        .facilityClass = FACILITY_CLASS_DRAGON_TAMER,
        .trainerName = _("BRODY"),
        .speechBefore = {EC_WORD_MY, EC_WORD_FASHION, EC_WORD_SENSE, EC_WORD_SEEMS, EC_POKEMON(ATTACK_FLANDRE), EC_WORD_QUES},
    ...
    [FRONTIER_TRAINER_KAILA] = {
        ...
        .speechLose = {EC_WORD_THAT, EC_WORD_LOSS, EC_WORD_IS, EC_WORD_HARD, EC_WORD_TO, EC_MOVE2(SHADOW_DANCE)},
    ...
    [FRONTIER_TRAINER_ISSAC] = {
        ...
        .speechLose = {EC_WORD_I, EC_WORD_DISLIKE, EC_WORD_ANY, EC_WORD_KIND, EC_WORD_OF, EC_MOVE2(SUB_ZERO)},
    ...
    [FRONTIER_TRAINER_GUSTAVO] = {
        ...
        .speechBefore = {EC_MOVE(BATTERY_CHARGE), EC_WORD_EXCL, EC_EMPTY_WORD, EC_MOVE(BATTERY_CHARGE), EC_WORD_EXCL_EXCL, EC_EMPTY_WORD},
    ...
    [FRONTIER_TRAINER_GAVIN] = {
        .facilityClass = FACILITY_CLASS_POKEFAN_M,
        .trainerName = _("GAVIN"),
        .speechBefore = {EC_WORD_I, EC_WORD_WILL, EC_MOVE(BURN_POWDER), EC_WORD_MY, EC_WORD_TIME, EC_EMPTY_WORD},
    ...
    [FRONTIER_TRAINER_BAILEY] = {
        ...
        .speechWin = {EC_WORD_I_AM, EC_WORD_AN, EC_WORD_ADULT, EC_WORD_I, EC_MOVE2(SHADOW_DANCE), EC_WORD_JOY},
        .speechLose = {EC_WORD_I_AM, EC_WORD_AN, EC_WORD_ADULT, EC_WORD_I, EC_MOVE2(SHADOW_DANCE), EC_MOVE2(FRUSTRATION)},
