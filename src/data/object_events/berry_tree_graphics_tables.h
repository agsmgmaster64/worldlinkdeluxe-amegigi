...
const u8 *const gBerryTreePaletteSlotTablePointers[] = {
    ...
    [ITEM_PUMKIN_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_DRASH_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_EGGANT_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_STRIB_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_TURLAN_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_NUTPEA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_IONNO_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_KUO_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_YAGO_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_TOUGA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_GARLIG_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
    [ITEM_TOPO_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteSlotTable_Durin,
};
