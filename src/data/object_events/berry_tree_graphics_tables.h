...
const u16 gBerryTreePaletteTagTable_Haban[] = {OBJ_EVENT_PAL_TAG_NPC_2, OBJ_EVENT_PAL_TAG_NPC_3, 3, 3, 3};
...
const struct SpriteFrameImage *const gBerryTreePicTablePointers[] = {
    ...
    [ITEM_PUMKIN_BERRY - FIRST_BERRY_INDEX]           = sPicTable_DurinBerryTree,
    [ITEM_DRASH_BERRY - FIRST_BERRY_INDEX]            = sPicTable_DurinBerryTree,
    [ITEM_EGGANT_BERRY - FIRST_BERRY_INDEX]           = sPicTable_DurinBerryTree,
    [ITEM_STRIB_BERRY - FIRST_BERRY_INDEX]            = sPicTable_DurinBerryTree,
    [ITEM_TURLAN_BERRY - FIRST_BERRY_INDEX]           = sPicTable_GrepaBerryTree,
    [ITEM_NUTPEA_BERRY - FIRST_BERRY_INDEX]           = sPicTable_DurinBerryTree,
    [ITEM_IONNO_BERRY - FIRST_BERRY_INDEX]            = sPicTable_DurinBerryTree,
    [ITEM_KUO_BERRY - FIRST_BERRY_INDEX]              = sPicTable_DurinBerryTree,
    [ITEM_YAGO_BERRY - FIRST_BERRY_INDEX]             = sPicTable_DurinBerryTree,
    [ITEM_TOUGA_BERRY - FIRST_BERRY_INDEX]            = sPicTable_DurinBerryTree,
    [ITEM_GARLIG_BERRY - FIRST_BERRY_INDEX]           = sPicTable_DurinBerryTree,
    [ITEM_TOPO_BERRY - FIRST_BERRY_INDEX]             = sPicTable_DurinBerryTree,
};
...
const u16 *const gBerryTreePaletteTagTablePointers[] = {
    ...
    [ITEM_PUMKIN_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_DRASH_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_EGGANT_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_STRIB_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_TURLAN_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Grepa,
    [ITEM_NUTPEA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_IONNO_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_KUO_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_YAGO_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_TOUGA_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_GARLIG_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
    [ITEM_TOPO_BERRY - FIRST_BERRY_INDEX] = gBerryTreePaletteTagTable_Durin,
};
...
const u16 *const gBerryTreeObjectEventGraphicsIdTablePointers[] = {
    ...
    [ITEM_STRIB_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_TURLAN_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_NUTPEA_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_IONNO_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_KUO_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_YAGO_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_TOUGA_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_GARLIG_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
    [ITEM_TOPO_BERRY - FIRST_BERRY_INDEX] = gBerryTreeObjectEventGraphicsIdTable,
};
