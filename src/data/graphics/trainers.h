...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_RENKO, gTrainerFrontPic_Renko, gTrainerPalette_Renko),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MARIBEL, gTrainerFrontPic_Maribel, gTrainerPalette_Maribel),
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_GIGI_MURIN, gTrainerFrontPic_GigiMurin, gTrainerPalette_GigiMurin),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_DOISE, gTrainerFrontPic_Doise, gTrainerPalette_Doise),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MISCHIEVOUS_FAIRY, gTrainerFrontPic_MischievousFairy, gTrainerPalette_MischievousFairy),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_SUNFLOWER_FAIRY, gTrainerFrontPic_SunflowerFairy, gTrainerPalette_SunflowerFairy),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_RENKO_YOUNG, gTrainerFrontPic_RenkoYoung, gTrainerPalette_RenkoYoung),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_MARIBEL_YOUNG, gTrainerFrontPic_MaribelYoung, gTrainerPalette_MaribelYoung),
...
{
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_RENKO, 5, gTrainerBackPic_Renko, gTrainerBackPicPalette_Renko, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_MARIBEL, 5, gTrainerBackPic_Maribel, gTrainerBackPicPalette_Maribel, sBackAnims_Kanto),
    ...
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_RENKO_YOUNG, 5, gTrainerBackPic_RenkoYoung, gTrainerBackPicPalette_RenkoYoung, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_MARIBEL_YOUNG, 5, gTrainerBackPic_MaribelYoung, gTrainerBackPicPalette_MaribelYoung, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_GIGI, 5, gTrainerBackPic_Gigi, gTrainerBackPicPalette_Gigi, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_KRONII, 5, gTrainerBackPic_Kronii, gTrainerBackPicPalette_Kronii, sBackAnims_Kanto),
};
