...
const u16 gBattleTerrainPalette_Plain[] = INCBIN_U32("graphics/battle_terrain/plain/palette.gbapal");
...
const u16 gBattleTerrainPalette_Ice[] = INCBIN_U32("graphics/battle_terrain/ice/palette.gbapal");
