...
static const u16 sVariableDmgMoves[] =
{
    ...
    MOVE_HORN_DRILL, MOVE_FLAIL, MOVE_REVERSAL, MOVE_MULTI_PULSE,
...
#define power arg2
    ...
    case PTS_MUD_SPORT:
        ...
        if (tvPtr->pos[defSide][0].mudSportMonId != -(tvPtr->pos[defSide][1].mudSportMonId) && gMovesInfo[move].type == TYPE_WIND)
        {
