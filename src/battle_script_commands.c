...
s32 CalcCritChanceStageArgs(u32 battlerAtk, u32 battlerDef, u32 move, bool32 recordAbility, u32 abilityAtk, u32 abilityDef, u32 holdEffectAtk)
{
    ...
    if (critChance != -1 && (abilityDef == ABILITY_GUARD_ARMOR || abilityDef == ABILITY_SHELL_ARMOR))
    {
...
static void Cmd_setfocusenergy(void)
{
    ...
    else if (gMovesInfo[gCurrentMove].effect == EFFECT_DRAGON_CHEER && !IS_BATTLER_OF_TYPE(battler, TYPE_FAITH))
    {
