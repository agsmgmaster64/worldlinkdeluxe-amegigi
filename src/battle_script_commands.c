...
static const u16 sNaturePowerMoves[BATTLE_TERRAIN_COUNT] =
{
    ...
    [BATTLE_TERRAIN_GRASS]      = MOVE_ENERGY_LIGHT,
    [BATTLE_TERRAIN_LONG_GRASS] = MOVE_ENERGY_LIGHT,
...
static const u8 sTerrainToType[BATTLE_TERRAIN_COUNT] =
{
    ...
    [BATTLE_TERRAIN_MOUNTAIN]         = (B_CAMOUFLAGE_TYPES >= GEN_5 ? TYPE_EARTH : TYPE_BEAST),
    [BATTLE_TERRAIN_PLAIN]            = (B_CAMOUFLAGE_TYPES >= GEN_4 ? TYPE_EARTH : TYPE_ILLUSION),
};
...
bool32 CanPoisonType(u8 battlerAttacker, u8 battlerTarget)
{
    return GetBattlerAbility(battlerAttacker) == ABILITY_CORROSION
        || !IS_BATTLER_ANY_TYPE(battlerTarget, TYPE_MIASMA, TYPE_STEEL);
}
