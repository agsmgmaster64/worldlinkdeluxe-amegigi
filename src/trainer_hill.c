...
static const u16 sPrizeListLuxuryBall1[] = {ITEM_LUXURY_ORB,      ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListLuxuryBall2[] = {ITEM_LUXURY_ORB,      ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
