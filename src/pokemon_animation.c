...
{
    [SPECIES_CHIBI_REIMU]                    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_NORMAL_REIMU]                      = BACK_ANIM_H_SLIDE,
    [SPECIES_ATTACK_REIMU]                 = BACK_ANIM_H_SHAKE,
    [SPECIES_DEFENSE_REIMU]                = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CHIBI_MARISA]                 = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_NORMAL_MARISA]                = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_ATTACK_MARISA]                = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SPEED_MARISA]                 = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CHIBI_DAIYOUSEI]              = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_NORMAL_DAIYOUSEI]             = BACK_ANIM_H_SLIDE,
    [SPECIES_ATTACK_DAIYOUSEI]             = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_DEFENSE_DAIYOUSEI]            = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_CHIBI_CIRNO]                       = BACK_ANIM_H_SLIDE,
    [SPECIES_NORMAL_CIRNO]                       = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SPEED_CIRNO]                     = BACK_ANIM_H_VIBRATE,
    [SPECIES_TECH_CIRNO]                       = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_CHIBI_RUMIA]                    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_NORMAL_RUMIA]                      = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_ATTACK_RUMIA]                 = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_SPEED_RUMIA]                  = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_CHIBI_MEILING]                = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_NORMAL_MEILING]               = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DEFENSE_MEILING]              = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_SPEED_MEILING]                = BACK_ANIM_V_SHAKE,
    [SPECIES_CHIBI_KOAKUMA]                      = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_NORMAL_KOAKUMA]                       = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_HELPER_KOAKUMA]                    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_PLCEHOLDER1_KOAKUMA]                    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_CHIBI_PATCHOULI]                    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_NORMAL_PATCHOULI]                     = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ATTACK_PATCHOULI]                    = BACK_ANIM_V_SHAKE,
    [SPECIES_DEFENSE_PATCHOULI]                    = BACK_ANIM_CONCAVE_ARC_SMALL,
    ...
    [SPECIES_CHIBI_YOUMU]                  = BACK_ANIM_H_SLIDE,
    [SPECIES_NORMAL_YOUMU]                 = BACK_ANIM_H_SLIDE,
    [SPECIES_DEFENSE_YOUMU]                = BACK_ANIM_H_SLIDE,
    [SPECIES_SPEED_YOUMU]                  = BACK_ANIM_H_SLIDE,
    ...
    [SPECIES_CHIBI_REISEN]                       = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_NORMAL_REISEN]                      = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_DEFENSE_REISEN]                      = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_TECH_REISEN]                       = BACK_ANIM_DIP_RIGHT_SIDE,
