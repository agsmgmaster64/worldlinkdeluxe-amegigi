...
{
    { .species = SPECIES_CHIBI_REIMU,                       .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_DEFENSE_REIMU,                     .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ATTACK_MARISA,                     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_NORMAL_DAIYOUSEI,                  .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ATTACK_DAIYOUSEI,                  .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CHIBI_CIRNO,                            .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_NORMAL_CIRNO,                            .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ATTACK_RUMIA,                           .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CHIBI_MINORIKO_SANNIAN,                    .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_SPEED_RUMIA,                          .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_NORMAL_MINORIKO_SANNIAN,                   .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CHIBI_KOAKUMA,                           .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_HELPER_KOAKUMA,                         .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_NORMAL_SHIZUHA_SANNIAN,                  .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_CHIBI_PATCHOULI,                         .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_CHIBI_ALICE,                            .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_MEOWTH_ALOLAN,                     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_MEOWTH_GALARIAN,                   .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ATTACK_ALICE,                           .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_CHIBI_LILY_WHITE,                            .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ATTACK_LILY_WHITE,                         .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CHIBI_LILY_BLACK,                           .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_NORMAL_MERLIN,                        .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_ATTACK_CHEN,                          .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_DEFENSE_YUKARI,                            .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_CHIBI_SHIZUHA,                          .jumpType = JUMP_TYPE_NORMAL, },
