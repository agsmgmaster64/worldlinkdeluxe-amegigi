...
{
    { .species = SPECIES_PLACEHOLD_RIKAKO,                           .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_PLACEHOLD_CHIYURI,                          .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_PLACEHOLD_YUMEMI,                            .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PLACEHOLD_ORANGE,                            .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_NORMAL_KURUMI,                         .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CHIBI_ELLY,                             .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_CHIBI_KAZAMI,                             .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_NORMAL_MUGETSU,                          .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_PLACEHOLD_SARA,                         .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CHIBI_LOUISE,                            .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PLACEHOLD_LOUISE,                           .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CHIBI_MARGATROID,                  .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_CHERRIM_SUNSHINE,                  .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_NORMAL_MARGATROID,                  .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_SHELLOS_EAST,                  .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_CHIBI_MAI,                           .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_NORMAL_YUMEKO,                           .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_NORMAL_SHINKI,                            .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_YOUKI,                            .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_TORI,                           .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_NAMAZU,                           .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_SPEED_SARIEL,                          .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ADVENT_YUKARI,                      .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ADVENT_EIRIN,                             .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ADVENT_REIMU,                             .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_DARK_ALICE,                          .jumpType = JUMP_TYPE_NORMAL, },
