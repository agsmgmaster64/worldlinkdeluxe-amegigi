...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_WLD_CAUGHT}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_WLD_CAUGHT}{PAUSE 127}"),
    ...
    [STRINGID_THREWROCK]                            = COMPOUND_STRING("{B_PLAYER_NAME} threw a Rock at the {B_OPPONENT_MON1_NAME}!"), //safari
    [STRINGID_THREWBAIT]                            = COMPOUND_STRING("{B_PLAYER_NAME} threw some Bait at the {B_OPPONENT_MON1_NAME}!"), //safari
    [STRINGID_PKMNWATCHINGCAREFULLY]                = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} is watching carefully!"), //safari
    [STRINGID_PKMNANGRY]                            = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} is angry!"), //safari
    [STRINGID_PKMNEATING]                           = COMPOUND_STRING("{B_OPPONENT_MON1_NAME} is eating!"), //safari
    ...
    [STRINGID_AURABREAKENTERS]                      = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} reversed all other Puppets' auras!"),
    ...
    [STRINGID_PLAYERLOSTTOENEMYTRAINER]             = COMPOUND_STRING("You have no more Puppets that can fight!\pYou lost to {B_TRAINER1_NAME_WITH_CLASS}!{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} weakened the {B_BUFF1} of all surrounding Puppets!\p"),
    ...
    [STRINGID_PLAYERWHITEDOUT]                      = COMPOUND_STRING("You were overwhelmed by your defeat!{PAUSE_UNTIL_PRESS}"),
    [STRINGID_PKMNPREVENTSFROSTBITEWITH]            = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} prevents frostbite!"), //not in gen 5+, ability popup
    [STRINGID_PKMNALREADYHASFROSTBITE]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is already frostbit!"),
    [STRINGID_PKMNDROPPEDITEM]                      = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} dropped its {B_LAST_ITEM}!{WAIT_SE}\p"),
    [STRINGID_BAGISFULL]                            = COMPOUND_STRING("{B_SCR_ACTIVE_NAME_WITH_PREFIX} dropped its {B_LAST_ITEM}!{WAIT_SE}\pBut your bag is full!\p"),
