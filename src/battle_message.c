...
static const u8 sText_StopLearningMove[] = _("{PAUSE 32}Do you want to continue having {B_BUFF1} learn {B_BUFF2}?");
...
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} makes Earth-type moves miss with {B_DEF_ABILITY}!"); //not in gen 5+, ability popup
...
static const u8 sText_PlayerLostToEnemyTrainer[] = _("You have no more Puppets that can fight!\pYou lost to {B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
...
static const u8 sText_PlayerWhiteout[] = _("You have no more Puppets that can fight!\p");
...
static const u8 sText_HitXTimes[] = _("The Puppet was hit {B_BUFF1} time(s)!"); //SV has dynamic plural here
...
static const u8 sText_PkmnFrostbitBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_BUFF1} frostbit {B_EFF_NAME_WITH_PREFIX2}!"); //not in gen 5+, ability popup
static const u8 sText_PkmnAlreadyHasFrostbite[] = _("{B_DEF_NAME_WITH_PREFIX} is already frostbit!");
...
static const u8 sText_NaturePowerTurnedInto[] = _("Native Power turned into {B_CURRENT_MOVE}!");
...
static const u8 sText_ItSuckedLiquidOoze[] = _("{B_ATK_NAME_WITH_PREFIX} sucked up the strange mist!");
...
static const u8 sText_FaintInThree[] = _("All Puppets that heard the song will faint in three turns!");
...
static const u8 sText_EnemyAboutToSwitchPkmn[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} is about to send out {B_BUFF2}.\pWill you switch your Puppet?");
...
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE SE_DING_DONG}Announcer: You're out of Safari Orbs! Game over!\p"); //safari
...
static const u8 sText_TrainerBlockedBall[] = _("The Trainer blocked your Toho Orb!");
static const u8 sText_DontBeAThief[] = _("Don't be a thief!");
static const u8 sText_ItDodgedBall[] = _("It dodged your thrown Toho Orb! This Puppet can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("You missed the Puppet!");
static const u8 sText_PkmnBrokeFree[] = _("Oh no! The Puppet broke free!");
...
static const u8 sText_PkmnDataAddedToDex[] = _("{B_DEF_NAME}'s data has been added to the iDollDex!\p");
...
static const u8 sText_PkmnHearingFluteAwoke[] = _("The Puppets hearing the flute awoke!");
static const u8 sText_YouThrowABallNowRight[] = _("You throw an Orb now, right? I… I'll do my best!");
...
static const u8 sText_HeldItemsLoseEffects[] =_("It created a bizarre area in which Puppets' held items lose their effects!");
static const u8 sText_BizarreArenaCreated[] =_("A bizarre area was created in which Puppets' held items lose their effects!");
...
static const u8 sText_HolyTerrainEnds[] = _("The battlefield returned to normal.");
...
static const u8 sText_FeltBetterWithEarlyBird[] = _("{B_ATK_NAME_WITH_PREFIX} felt better with its {B_ATK_ABILITY}!");
static const u8 sText_TargetFeltBetterWithEarlyBird[] = _("{B_DEF_NAME_WITH_PREFIX} felt better with its {B_DEF_ABILITY}!");
...
static const u8 sText_TerrainBecomesHoly[] = _("The battlefield became holy!");
...
static const u8 sText_PowderExplodes[] = _("When the flame touched the powder on the Puppet, it exploded!");
...
static const u8 sText_HolyTerrainPreventsRaiseStats[] = _("{B_DEF_NAME_WITH_PREFIX} surrounds itself with holy terrain!");
...
static const u8 sText_AuraBreakActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} reversed all other Puppets' auras!");
...
static const u8 sText_PkmnsWillPerishIn3Turns[] = _("Both Puppets will perish in three turns!");  //don't think this message is displayed anymore
...
static const u8 sText_MysteriousAirCurrent[] = _("Mysterious strong winds are protecting Flying-type Puppets!");
...
static const u8 sText_BothCanNoLongerEscape[] = _("Neither Puppet can run away!");
...
static const u8 sText_AbilityWeakenedSurroundingMonsStat[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} weakened the {B_BUFF1} of all surrounding Puppets!\p");
...
static const u8 sText_SharpSteelFloats[] = _("Sharp-pointed pieces of steel started floating around {B_DEF_TEAM2} Puppets!");
...
static const u8 sText_SharpSteelDisappearedFromTeam[] = _("The pieces of steel surrounding {B_ATK_TEAM2} Puppets disappeared!");
static const u8 sText_TeamTrappedWithVines[] = _("{B_DEF_TEAM1} Puppets got trapped with vines!");
static const u8 sText_PkmnHurtByVines[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Vine Lash's ferocious beating!");
static const u8 sText_TeamCaughtInVortex[] = _("{B_DEF_TEAM1} Puppets got caught in a vortex of water!");
static const u8 sText_PkmnHurtByVortex[] = _("{B_ATK_NAME_WITH_PREFIX} is hurt by G-Max Cannonade's vortex!");
static const u8 sText_TeamSurroundedByFire[] = _("{B_DEF_TEAM1} Puppets were surrounded by fire!");
static const u8 sText_PkmnBurningUp[] = _("{B_ATK_NAME_WITH_PREFIX} is burning up within G-Max Wildfire's flames!");
static const u8 sText_TeamSurroundedByRocks[] = _("{B_DEF_TEAM1} Puppets became surrounded by rocks!");
...
static const u8 sText_PkmnPreventsFrostbiteWith[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} prevents frostbite!");
...
static const u8 sText_BagIsFull[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} dropped its {B_LAST_ITEM}!{WAIT_SE}\pBut your bag is full!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_HOLYTERRAINENDS - BATTLESTRINGS_TABLE_START] = sText_HolyTerrainEnds,
    ...
    [STRINGID_TERRAINBECOMESHOLY - BATTLESTRINGS_TABLE_START] = sText_TerrainBecomesHoly,
    ...
    [STRINGID_HOLYTERRAINPREVENTS - BATTLESTRINGS_TABLE_START] = sText_HolyTerrainPreventsRaiseStats,
    ...
    [STRINGID_PKMNFROSTBITBY - BATTLESTRINGS_TABLE_START] = sText_PkmnFrostbitBy,
    [STRINGID_FELTBETTERWITHABILITY - BATTLESTRINGS_TABLE_START] = sText_FeltBetterWithEarlyBird,
    [STRINGID_TARGETFELTBETTERWITHABILITY - BATTLESTRINGS_TABLE_START] = sText_TargetFeltBetterWithEarlyBird,
};
...
const u16 gFRBPreventionStringIds[] =
{
...
const u8 gText_MoveInterfacePhyscial[] = _("/Phys");
