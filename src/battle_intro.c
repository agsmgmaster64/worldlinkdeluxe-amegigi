...
static const TaskFunc sBattleIntroSlideFuncs[] =
{
    ...
    [BATTLE_ENVIRONMENT_SOARING]          = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_SKY_PILLAR]       = BattleIntroSlide3,
    [BATTLE_ENVIRONMENT_BURIAL_GROUND]    = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_PUDDLE]           = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_MARSH]            = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_SNOW]             = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_ICE]              = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_VOLCANO]          = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_DISTORTION_WORLD] = BattleIntroSlide1,
    [BATTLE_ENVIRONMENT_SPACE]            = BattleIntroSlide1,
