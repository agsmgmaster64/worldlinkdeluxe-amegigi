    ...
    case ABILITYEFFECT_WOULD_ABSORB:
        if (move != MOVE_NONE)
        {
            ...
            case ABILITY_LIGHTNING_ROD:
                if (B_REDIRECT_ABILITY_IMMUNITY >= GEN_5 && moveType == TYPE_WIND && gMovesInfo[move].target != MOVE_TARGET_ALL_BATTLERS)
...
static inline u32 CalcMoveBasePowerAfterModifiers(u32 move, u32 battlerAtk, u32 battlerDef, u32 moveType, bool32 updateFlags, u32 atkAbility, u32 defAbility, u32 holdEffectAtk, u32 weather)
{
    ...
    case ABILITY_RIVALRY:
        ...
        break;
// i mean, i keep being reminded of the heated waters around me
// i have no choice but to stay out of it to not get swallowed within
// it's just, what do people even want out of me?
