...
static const struct ListMenuItem sDebugMenu_Items_Utilities[] =
{
    ...
    [DEBUG_UTIL_MENU_ITEM_CHANGE_VIAL_SIZE] = {COMPOUND_STRING("Set Vial Size…{CLEAR_TO 110}{RIGHT_ARROW}"),  DEBUG_UTIL_MENU_ITEM_CHANGE_VIAL_SIZE},
};
...
static const struct ListMenuItem sDebugMenu_Items_Party[] =
{
    ...
    [DEBUG_PARTY_MENU_ITEM_SET_TERA_TYPE]   = {COMPOUND_STRING("Set Tera Type"),   DEBUG_PARTY_MENU_ITEM_SET_TERA_TYPE},
...
static const struct ListMenuItem sDebugMenu_Items_FlagsVars[] =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_DYNAMAX]       = {COMPOUND_STRING("Toggle {STR_VAR_1}Dynamax"),                DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_DYNAMAX},
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TERASTALIZE]   = {COMPOUND_STRING("Toggle {STR_VAR_1}Terastallization"),       DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_TERASTALIZE},
};
