...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TRAINER_CLASS_PKMN_BREEDER, "{PKMN} BREEDER", 10),
    TRAINER_CLASS(TRAINER_CLASS_COOLTRAINER, "Ace Trainer", 12, BALL_ULTRA),
    ...
    TRAINER_CLASS(TRAINER_CLASS_HOLOLIVE_MEMBER, "Hololive", 25, BALL_LUXURY),
    TRAINER_CLASS(TRAINER_CLASS_THE_GUY, "The", 10, BALL_FOUL),
