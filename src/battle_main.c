...
#define DEFAULT_BALL ITEM_TOHO_ORB
...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(PKMN_BREEDER, "{PKMN} BREEDER", 10, DEFAULT_BALL),
    TRAINER_CLASS(COOLTRAINER, "COOLTRAINER", 12, ITEM_ULTRA_ORB),
    ...
    TRAINER_CLASS(FISHERMAN, "FISHERMAN", 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_DIVE_ORB : ITEM_LURE_BALL),
    ...
    TRAINER_CLASS(COOLTRAINER_2, "COOLTRAINER", DEFAULT_MONEY, ITEM_ULTRA_ORB),
