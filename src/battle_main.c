...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TRAINER_CLASS_COOLTRAINER, "COOLTRAINER", 12, ITEM_ULTRA_ORB),
...
u32 GetDynamicMoveType(struct Pokemon *mon, u32 move, u32 battler, u8 *ateBoost)
{
    ...
    else if (moveEffect == EFFECT_HIDDEN_POWER)
    {
        ...
        // Subtract 6 instead of 1 below because 5 types are excluded (TYPE_NONE, TYPE_ILLUSION, TYPE_MYSTERY, TYPE_COSMIC and TYPE_STELLAR)
    ...
    else if (moveEffect == EFFECT_MULTI_PULSE)
    {
