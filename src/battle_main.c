...
#define TRAINER_CLASS(trainerClass, trainerName, ...)   \
    ...
    {                                                   \
        ...
        .ball = DEFAULT_2(ITEM_TOHO_ORB, __VA_ARGS__), \
    }
...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(TRAINER_CLASS_PKMN_BREEDER, "{PKMN} BREEDER"),
    TRAINER_CLASS(TRAINER_CLASS_COOLTRAINER, "Ace Trainer", 12, ITEM_ULTRA_ORB),
    TRAINER_CLASS(TRAINER_CLASS_BIRD_KEEPER, "BIRD KEEPER", 8),
    TRAINER_CLASS(TRAINER_CLASS_COLLECTOR, "COLLECTOR", 15, ITEM_PREMIER_ORB),
    TRAINER_CLASS(TRAINER_CLASS_SWIMMER_M, "SWIMMER♂", 2, ITEM_DIVE_ORB),
    ...
    TRAINER_CLASS(TRAINER_CLASS_BLACK_BELT, "BLACK BELT", 8, ITEM_ULTRA_ORB),
    TRAINER_CLASS(TRAINER_CLASS_AQUA_LEADER, "AQUA LEADER", 20, ITEM_MASTER_ORB),
    ...
    TRAINER_CLASS(TRAINER_CLASS_POKEMANIAC, "Fairy Maniac", 15),
    ...
    TRAINER_CLASS(TRAINER_CLASS_GENTLEMAN, "GENTLEMAN", 20, ITEM_LUXURY_ORB),
    TRAINER_CLASS(TRAINER_CLASS_ELITE_FOUR, "ELITE FOUR", 25, ITEM_ULTRA_ORB),
    TRAINER_CLASS(TRAINER_CLASS_LEADER, "Leader", 25),
    TRAINER_CLASS(TRAINER_CLASS_SCHOOL_KID, "SCHOOL KID"),
    TRAINER_CLASS(TRAINER_CLASS_SR_AND_JR, "Teammates", 4),
    ...
    TRAINER_CLASS(TRAINER_CLASS_FISHERMAN, "Fisherman", 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_DIVE_ORB : ITEM_LURE_BALL),
    ...
    TRAINER_CLASS(TRAINER_CLASS_SWIMMER_F, "SWIMMER♀", 2, ITEM_DIVE_ORB),
    TRAINER_CLASS(TRAINER_CLASS_TWINS, "TWINS", 3),
    TRAINER_CLASS(TRAINER_CLASS_SAILOR, "SAILOR", 8),
    TRAINER_CLASS(TRAINER_CLASS_COOLTRAINER_2, "COOLTRAINER", 5, ITEM_ULTRA_ORB),
    TRAINER_CLASS(TRAINER_CLASS_MAGMA_ADMIN, "MAGMA ADMIN", 10),
    TRAINER_CLASS(TRAINER_CLASS_RIVAL, "{PKMN} TRAINER", 15),
    TRAINER_CLASS(TRAINER_CLASS_BUG_CATCHER, "Fairy Hunter", 4),
    TRAINER_CLASS(TRAINER_CLASS_PKMN_RANGER, "{PKMN} RANGER", 12),
    TRAINER_CLASS(TRAINER_CLASS_MAGMA_LEADER, "MAGMA LEADER", 20, ITEM_MASTER_ORB),
    ...
    TRAINER_CLASS(TRAINER_CLASS_HOLOLIVE_MEMBER, "Hololive", 25, ITEM_LUXURY_ORB),
    TRAINER_CLASS(TRAINER_CLASS_THE_GUY, "The", 10, ITEM_FOUL_ORB),
    TRAINER_CLASS(TRAINER_CLASS_MISCHIEVOUS_FAIRY, "Mischievous", 4),
    TRAINER_CLASS(TRAINER_CLASS_SUNFLOWER_FAIRY, "Sunflower", 10),
};
