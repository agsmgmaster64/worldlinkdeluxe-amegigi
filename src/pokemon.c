...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(NORMAL_REISEN),
    HOENN_TO_NATIONAL(DEFENSE_REISEN),
    ...
    HOENN_TO_NATIONAL(HELPER_KOAKUMA),
    HOENN_TO_NATIONAL(PLCEHOLDER1_KOAKUMA),
    ...
    HOENN_TO_NATIONAL(CHIBI_KOAKUMA),
    HOENN_TO_NATIONAL(NORMAL_KOAKUMA),
    ...
    HOENN_TO_NATIONAL(CHIBI_REISEN),
...
static inline bool32 CanFirstMonBoostHeldItemRarity(void)
{
    if (GetMonData(&gPlayerParty[0], MON_DATA_SANITY_IS_EGG))
        return FALSE;
    else if ((OW_COMPOUND_EYES < GEN_9) && GetMonAbility(&gPlayerParty[0]) == ABILITY_FOCUS)
        return TRUE;
