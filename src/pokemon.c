...
{
    [TRAINER_BACK_PIC_RENKO] = {
        .tileTag = TAG_NONE,
        .paletteTag = 0,
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Renko,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_MARIBEL] = {
        .tileTag = TAG_NONE,
        .paletteTag = 0,
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Maribel,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
...
u32 GetBoxMonData3(struct BoxPokemon *boxMon, s32 field, u8 *data)
{
    ...
    // Any field greater than MON_DATA_MARKINGS is encrypted and must be treated as such
    if (field > MON_DATA_HP_LOST)
    {
        ...
        case MON_DATA_NICKNAME10:
        {
            ...
            else
            {
                ...
                {
                    if (substruct0->nickname11 == 0 && substruct0->nickname12 == 0 && substruct2->nickname13 == 0)
                    {
                        data[retVal++] = EOS;
                        data[retVal++] = EOS;
                        data[retVal++] = EOS;
                    ...
                    else
                    {
                        ...
                        data[retVal++] = substruct2->nickname13;
                    }
                }
        ...
        case MON_DATA_HYPER_TRAINED_HP:
            retVal = substruct2->hyperTrainedHP;
            break;
        case MON_DATA_HYPER_TRAINED_ATK:
            retVal = substruct2->hyperTrainedAttack;
            break;
        case MON_DATA_HYPER_TRAINED_DEF:
            retVal = substruct2->hyperTrainedDefense;
            break;
        case MON_DATA_HYPER_TRAINED_SPEED:
            retVal = substruct2->hyperTrainedSpeed;
            break;
        case MON_DATA_HYPER_TRAINED_SPATK:
            retVal = substruct2->hyperTrainedSpAttack;
            break;
        case MON_DATA_HYPER_TRAINED_SPDEF:
            retVal = substruct2->hyperTrainedSpDefense;
            break;
...
void SetBoxMonData(struct BoxPokemon *boxMon, s32 field, const void *dataArg)
{
    ...
    if (field > MON_DATA_HP_LOST)
    {
        ...
        case MON_DATA_NICKNAME10:
        {
            ...
            if (field != MON_DATA_NICKNAME10)
            {
                ...
                if (POKEMON_NAME_LENGTH >= 13)
                    substruct2->nickname13 = data[12];
            }
            else
            {
                substruct0->nickname11 = EOS;
                substruct0->nickname12 = EOS;
                substruct2->nickname13 = EOS;
            }
            break;
        }
        case MON_DATA_SPECIES:
        ...
        case MON_DATA_HYPER_TRAINED_HP:
            SET8(substruct2->hyperTrainedHP);
            break;
        case MON_DATA_HYPER_TRAINED_ATK:
            SET8(substruct2->hyperTrainedAttack);
            break;
        case MON_DATA_HYPER_TRAINED_DEF:
            SET8(substruct2->hyperTrainedDefense);
            break;
        case MON_DATA_HYPER_TRAINED_SPEED:
            SET8(substruct2->hyperTrainedSpeed);
            break;
        case MON_DATA_HYPER_TRAINED_SPATK:
            SET8(substruct2->hyperTrainedSpAttack);
            break;
        case MON_DATA_HYPER_TRAINED_SPDEF:
            SET8(substruct2->hyperTrainedSpDefense);
            break;
        case MON_DATA_IS_SHADOW:
