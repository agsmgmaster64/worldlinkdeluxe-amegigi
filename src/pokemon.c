...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(NORMAL_REISEN),
    SPECIES_TO_HOENN(DEFENSE_REISEN),
    ...
    SPECIES_TO_HOENN(NORMAL_YOUMU),
    SPECIES_TO_HOENN(DEFENSE_YOUMU),
#if P_GEN_4_POKEMON == TRUE
    ...
    SPECIES_TO_HOENN(HELPER_KOAKUMA),
    SPECIES_TO_HOENN(PLCEHOLDER1_KOAKUMA),
    ...
    SPECIES_TO_HOENN(CHIBI_KOAKUMA),
    SPECIES_TO_HOENN(NORMAL_KOAKUMA),
...
{
    SPECIES_TO_NATIONAL(CHIBI_REIMU),
    SPECIES_TO_NATIONAL(NORMAL_REIMU),
    SPECIES_TO_NATIONAL(ATTACK_REIMU),
    SPECIES_TO_NATIONAL(DEFENSE_REIMU),
    SPECIES_TO_NATIONAL(CHIBI_MARISA),
    SPECIES_TO_NATIONAL(NORMAL_MARISA),
    SPECIES_TO_NATIONAL(ATTACK_MARISA),
    SPECIES_TO_NATIONAL(SPEED_MARISA),
    SPECIES_TO_NATIONAL(CHIBI_DAIYOUSEI),
    SPECIES_TO_NATIONAL(NORMAL_DAIYOUSEI),
    SPECIES_TO_NATIONAL(ATTACK_DAIYOUSEI),
    SPECIES_TO_NATIONAL(DEFENSE_DAIYOUSEI),
    SPECIES_TO_NATIONAL(CHIBI_CIRNO),
    SPECIES_TO_NATIONAL(NORMAL_CIRNO),
    SPECIES_TO_NATIONAL(SPEED_CIRNO),
    SPECIES_TO_NATIONAL(TECH_CIRNO),
    SPECIES_TO_NATIONAL(CHIBI_RUMIA),
    SPECIES_TO_NATIONAL(NORMAL_RUMIA),
    SPECIES_TO_NATIONAL(ATTACK_RUMIA),
    SPECIES_TO_NATIONAL(SPEED_RUMIA),
    SPECIES_TO_NATIONAL(CHIBI_MEILING),
    SPECIES_TO_NATIONAL(NORMAL_MEILING),
    SPECIES_TO_NATIONAL(DEFENSE_MEILING),
    SPECIES_TO_NATIONAL(SPEED_MEILING),
    SPECIES_TO_NATIONAL(CHIBI_KOAKUMA),
    SPECIES_TO_NATIONAL(NORMAL_KOAKUMA),
    SPECIES_TO_NATIONAL(HELPER_KOAKUMA),
    SPECIES_TO_NATIONAL(PLCEHOLDER1_KOAKUMA),
    SPECIES_TO_NATIONAL(CHIBI_PATCHOULI),
    SPECIES_TO_NATIONAL(NORMAL_PATCHOULI),
    SPECIES_TO_NATIONAL(ATTACK_PATCHOULI),
    SPECIES_TO_NATIONAL(DEFENSE_PATCHOULI),
    ...
    SPECIES_TO_NATIONAL(CHIBI_YOUMU),
    SPECIES_TO_NATIONAL(NORMAL_YOUMU),
    SPECIES_TO_NATIONAL(DEFENSE_YOUMU),
    SPECIES_TO_NATIONAL(SPEED_YOUMU),
    ...
    SPECIES_TO_NATIONAL(NORMAL_REISEN),
    SPECIES_TO_NATIONAL(DEFENSE_REISEN),
    SPECIES_TO_NATIONAL(TECH_REISEN),
    ...
    // Megas
    [SPECIES_VENUSAUR_MEGA - 1] = NATIONAL_DEX_ATTACK_REIMU,
    [SPECIES_CHARIZARD_MEGA_X - 1] = NATIONAL_DEX_NORMAL_MARISA,
    [SPECIES_CHARIZARD_MEGA_Y - 1] = NATIONAL_DEX_NORMAL_MARISA,
    [SPECIES_BLASTOISE_MEGA - 1] = NATIONAL_DEX_CHIBI_DAIYOUSEI,
    [SPECIES_BEEDRILL_MEGA - 1] = NATIONAL_DEX_SPEED_CIRNO,
    [SPECIES_PIDGEOT_MEGA - 1] = NATIONAL_DEX_NORMAL_RUMIA,
    [SPECIES_ALAKAZAM_MEGA - 1] = NATIONAL_DEX_ALAKAZAM,
    [SPECIES_SLOWBRO_MEGA - 1] = NATIONAL_DEX_CHIBI_YOUMU,
    ...
    // Alolan Forms
    [SPECIES_RATTATA_ALOLAN - 1] = NATIONAL_DEX_ATTACK_RUMIA,
    [SPECIES_RATICATE_ALOLAN - 1] = NATIONAL_DEX_SPEED_RUMIA,
    [SPECIES_RAICHU_ALOLAN - 1] = NATIONAL_DEX_NORMAL_KOAKUMA,
    [SPECIES_SANDSHREW_ALOLAN - 1] = NATIONAL_DEX_HELPER_KOAKUMA,
    [SPECIES_SANDSLASH_ALOLAN - 1] = NATIONAL_DEX_PLCEHOLDER1_KOAKUMA,
    ...
    [SPECIES_SLOWBRO_GALARIAN - 1] = NATIONAL_DEX_CHIBI_YOUMU,
    [SPECIES_FARFETCHD_GALARIAN - 1] = NATIONAL_DEX_SPEED_YOUMU,
...
//Hisuian Forms
...
#endif
    // Cosplay Pikachu
    [SPECIES_PIKACHU_COSPLAY - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_ROCK_STAR - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_BELLE - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_POP_STAR - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_PH_D - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_LIBRE - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    // Cap Pikachu
    [SPECIES_PIKACHU_ORIGINAL_CAP - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_HOENN_CAP - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_SINNOH_CAP - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_UNOVA_CAP - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_KALOS_CAP - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_ALOLA_CAP - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_PARTNER_CAP - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    [SPECIES_PIKACHU_WORLD_CAP - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
    // Pichu
    ...
    // Gigantamax Forms
    [SPECIES_VENUSAUR_GIGANTAMAX - 1] = NATIONAL_DEX_ATTACK_REIMU,
    [SPECIES_CHARIZARD_GIGANTAMAX - 1] = NATIONAL_DEX_NORMAL_MARISA,
    [SPECIES_BLASTOISE_GIGANTAMAX - 1] = NATIONAL_DEX_CHIBI_DAIYOUSEI,
    [SPECIES_BUTTERFREE_GIGANTAMAX - 1] = NATIONAL_DEX_DEFENSE_DAIYOUSEI,
    [SPECIES_PIKACHU_GIGANTAMAX - 1] = NATIONAL_DEX_CHIBI_KOAKUMA,
...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(NORMAL_YOUMU),
    HOENN_TO_NATIONAL(DEFENSE_YOUMU),
#if P_GEN_4_POKEMON == TRUE
...
{   // Gen 1
    [SPECIES_CHIBI_REIMU - 1]                  = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_NORMAL_REIMU - 1]                 = ANIM_V_STRETCH,
    [SPECIES_ATTACK_REIMU - 1]                 = ANIM_ROTATE_UP_SLAM_DOWN,
    [SPECIES_DEFENSE_REIMU - 1]                = ANIM_V_JUMPS_SMALL,
    [SPECIES_CHIBI_MARISA - 1]                 = ANIM_BACK_AND_LUNGE,
    [SPECIES_NORMAL_MARISA - 1]                = ANIM_V_SHAKE,
    [SPECIES_ATTACK_MARISA - 1]                = ANIM_V_JUMPS_BIG,
    [SPECIES_SPEED_MARISA - 1]                 = ANIM_SHRINK_GROW,
    [SPECIES_CHIBI_DAIYOUSEI - 1]              = ANIM_V_SHAKE_TWICE,
    [SPECIES_NORMAL_DAIYOUSEI - 1]             = ANIM_SWING_CONCAVE,
    [SPECIES_ATTACK_DAIYOUSEI - 1]             = ANIM_SWING_CONCAVE,
    [SPECIES_DEFENSE_DAIYOUSEI - 1]            = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_CHIBI_CIRNO - 1]                       = ANIM_H_SLIDE_SLOW,
    [SPECIES_NORMAL_CIRNO - 1]                       = ANIM_GLOW_ORANGE,
    [SPECIES_SPEED_CIRNO - 1]                     = ANIM_ZIGZAG_SLOW,
    [SPECIES_TECH_CIRNO - 1]                       = ANIM_V_STRETCH,
    [SPECIES_CHIBI_RUMIA - 1]                    = ANIM_V_STRETCH,
    [SPECIES_NORMAL_RUMIA - 1]                      = ANIM_FRONT_FLIP,
    [SPECIES_ATTACK_RUMIA - 1]                      = ANIM_H_JUMPS,
    [SPECIES_SPEED_RUMIA - 1]                     = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_CHIBI_MEILING - 1]                      = ANIM_V_JUMPS_SMALL,
    [SPECIES_NORMAL_MEILING - 1]                       = ANIM_FIGURE_8,
    [SPECIES_DEFENSE_MEILING - 1]                        = ANIM_V_STRETCH,
    [SPECIES_SPEED_MEILING - 1]                        = ANIM_V_STRETCH,
    [SPECIES_CHIBI_KOAKUMA - 1]                      = ANIM_FLASH_YELLOW,
    [SPECIES_NORMAL_KOAKUMA - 1]                       = ANIM_GROW_VIBRATE,
    [SPECIES_HELPER_KOAKUMA - 1]                    = ANIM_SWING_CONCAVE_FAST_SHORT,
    [SPECIES_PLCEHOLDER1_KOAKUMA - 1]                    = ANIM_H_SHAKE,
    [SPECIES_CHIBI_PATCHOULI - 1]                    = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NORMAL_PATCHOULI - 1]                     = ANIM_V_STRETCH,
    [SPECIES_ATTACK_PATCHOULI - 1]                    = ANIM_H_SHAKE,
    [SPECIES_DEFENSE_PATCHOULI - 1]                    = ANIM_GROW_VIBRATE,
    ...
    [SPECIES_CHIBI_YOUMU - 1]                  = ANIM_H_STRETCH,
    [SPECIES_NORMAL_YOUMU - 1]                 = ANIM_H_STRETCH,
    [SPECIES_DEFENSE_YOUMU - 1]                = ANIM_H_STRETCH,
    [SPECIES_SPEED_YOUMU - 1]                  = ANIM_H_STRETCH,
    ...
    [SPECIES_CHIBI_REISEN - 1]                       = ANIM_V_SLIDE,
    [SPECIES_NORMAL_REISEN - 1]                      = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_DEFENSE_REISEN - 1]                      = ANIM_V_SLIDE_WOBBLE,
    [SPECIES_TECH_REISEN - 1]                       = ANIM_TWIST_TWICE,
...
{
    [SPECIES_CHIBI_DAIYOUSEI - 1]  = 20,
    [SPECIES_CHIBI_CIRNO - 1]     = 10,
    [SPECIES_NORMAL_CIRNO - 1]     = 20,
    [SPECIES_CHIBI_RUMIA - 1]  = 25,
    [SPECIES_NORMAL_MEILING - 1]     = 2,
    [SPECIES_DEFENSE_MEILING - 1]      = 30,
    [SPECIES_CHIBI_KOAKUMA - 1]    = 25,
    [SPECIES_CHIBI_PATCHOULI - 1]  = 28,
