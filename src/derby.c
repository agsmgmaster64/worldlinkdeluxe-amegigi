...
static const u32 PonytaGFX[] = INCBIN_U32("graphics/pokemon/_add/th/aya/chibi/anim_front.4bpp.lz");
...
static const u32 RapidashGFX[] = INCBIN_U32("graphics/pokemon/_add/th/aya/normal/anim_front.4bpp.lz");
...
static const u32 RattataGFX[] = INCBIN_U32("graphics/pokemon/_add/th/nazrin/chibi/anim_front.4bpp.lz");
...
static const u32 FeebasGFX[] = INCBIN_U32("graphics/pokemon/_add/th/wakasagihime/chibi/anim_front.4bpp.lz");
...
void GetNewDerby(void)
{
    ...
    {
        odds = (Random() % 3); // Ponyta/Rapidash/Rattata 0-2
