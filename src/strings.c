...
const u8 gText_PutAwayPokenav[] = _("Put away the iDollNav.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Return to the iDollNav menu.");
...
const u8 gText_ContinueMenuPokedex[] = _("iDollDex");
