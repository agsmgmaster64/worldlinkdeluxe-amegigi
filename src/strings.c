...
const u8 gText_Stats_Gender_0[]      = _("{YIN}");
const u8 gText_Stats_Gender_12_5[]   = _("{YIN} 7/1 {YANG}"); //_("♀ 12.5 / 87.5 ♂");
const u8 gText_Stats_Gender_25[]     = _("{YIN} 3/1 {YANG}");     //_("♀ 25 / 75 ♂");
const u8 gText_Stats_Gender_50[]     = _("{YIN} / {YANG}");     //_("♀ 50 / 50 ♂");
const u8 gText_Stats_Gender_75[]     = _("{YIN} 1/3 {YANG}");     //_("♀ 75 / 25 ♂");
const u8 gText_Stats_Gender_87_5[]   = _("{YIN} 1/7 {YANG}");
const u8 gText_Stats_Gender_100[]    = _("{YANG}");
