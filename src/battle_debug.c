...
static const u8 sText_LaserFocus[] = _("Ame");
...
static const u8 *const sHoldEffectNames[] =
{
    ...
    [HOLD_EFFECT_HEART_POWER] = sText_HoldEffectBugPower,
    [HOLD_EFFECT_DOUBLE_PRIZE] = sText_HoldEffectDoublePrize,
    [HOLD_EFFECT_REPEL] = sText_HoldEffectRepel,
    [HOLD_EFFECT_DOUBLE_SOUL] = sText_HoldEffectSoulDew,
    [HOLD_EFFECT_KUSANAGI] = sText_HoldEffectDeepSeaTooth,
    [HOLD_EFFECT_YATA_MIRROR] = sText_HoldEffectDeepSeaScale,
    ...
    [HOLD_EFFECT_ICY_BALL] = sText_HoldEffectLightBall,
    [HOLD_EFFECT_EARTH_POWER] = sText_HoldEffectGroundPower,
    [HOLD_EFFECT_BEAST_POWER] = sText_HoldEffectRockPower,
    [HOLD_EFFECT_NATURE_POWER] = sText_HoldEffectGrassPower,
    [HOLD_EFFECT_DARK_POWER] = sText_HoldEffectDarkPower,
    [HOLD_EFFECT_DREAM_POWER] = sText_HoldEffectFightingPower,
    [HOLD_EFFECT_WIND_POWER] = sText_HoldEffectElectricPower,
    [HOLD_EFFECT_WATER_POWER] = sText_HoldEffectWaterPower,
    [HOLD_EFFECT_FLYING_POWER] = sText_HoldEffectFlyingPower,
    [HOLD_EFFECT_MIASMA_POWER] = sText_HoldEffectPoisonPower,
    [HOLD_EFFECT_ICE_POWER] = sText_HoldEffectIcePower,
    [HOLD_EFFECT_GHOST_POWER] = sText_HoldEffectGhostPower,
    [HOLD_EFFECT_REASON_POWER] = sText_HoldEffectPsychicPower,
    [HOLD_EFFECT_FIRE_POWER] = sText_HoldEffectFirePower,
    [HOLD_EFFECT_FAITH_POWER] = sText_HoldEffectDragonPower,
    [HOLD_EFFECT_ILLUSION_POWER] = sText_HoldEffectNormalPower,
    [HOLD_EFFECT_UPGRADE] = sText_HoldEffectUpgrade,
    [HOLD_EFFECT_SHELL_BELL] = sText_HoldEffectShellBell,
    [HOLD_EFFECT_BIG_CLOUD] = sText_HoldEffectLuckyPunch,
    [HOLD_EFFECT_ASSIST_BALL] = sText_HoldEffectMetalPowder,
    [HOLD_EFFECT_DARK_RIBBON] = sText_HoldEffectThickClub,
    [HOLD_EFFECT_BLOOMERS] = sText_HoldEffectLeek,
    ...
    [HOLD_EFFECT_MUSIC_BALL] = sText_HoldEffectAdamantOrb,
    [HOLD_EFFECT_GLOW_BALL] = sText_HoldEffectLustrousOrb,
    [HOLD_EFFECT_DARK_BALL] = sText_HoldEffectGriseousOrb,
    ...
    [HOLD_EFFECT_COSMIC_POWER] = sText_HoldEffectFairyPower,
