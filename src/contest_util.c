...
static void Task_ShowWinnerMonBanner(u8 taskId)
{
    ...
    case 0:
        ...
        LoadCompressedUniqueSpritePaletteWithTag(GetMonSpritePalFromSpeciesAndPersonality(species, otId, personality), species, personality, IsShinyOtIdPersonality(otId, personality));
