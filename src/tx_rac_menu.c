...
static const u32 sTxRandChalTiles[] = INCBIN_U32("graphics/ui_tx_rac/tx_rac_tiles.4bpp.lz");
static const u16 sTxRandChalPalette[] = INCBIN_U16("graphics/ui_tx_rac/tx_rac_tiles.gbapal");
static const u32 sTxRandChalTilemap[] = INCBIN_U32("graphics/ui_tx_rac/tx_rac_tiles.bin.lz");

// Scrolling Background
static const u32 sScrollBgTiles[] = INCBIN_U32("graphics/ui_tx_rac/scroll_tiles.4bpp.lz");
static const u32 sScrollBgTilemap[] = INCBIN_U32("graphics/ui_tx_rac/scroll_tiles.bin.lz");
static const u16 sScrollBgPalette[] = INCBIN_U16("graphics/ui_tx_rac/scroll_tiles.gbapal");
...
static const u8 sText_Description_Nuzlocke_Normal[]             = _("One catch per route! Fainted Puppets\ncan't be used anymore.");
...
static const u8 sText_Description_Nuzlocke_SpeciesClause_On[]   = _("Only not prior caught Puppets count\nas first encounter. {COLOR 7}{COLOR 8}RECOMMENDED!");
...
static const u8 sText_Description_Nuzlocke_Deletion_Cemetery[]  = _("Fainted Puppets are send to the PC\nafter battle and can't be retrieved.");
static const u8 sText_Description_Nuzlocke_Deletion_Deletion[]  = _("Fainted Puppets are {COLOR 7}{COLOR 8}released{COLOR 1}{COLOR 2} after\nbattle!");
...
static const u8 sText_TopBar_Difficulty_Left[]  = _("{L_BUTTON}DIFFICULTY");
static const u8 sText_TopBar_Difficulty_Right[] = _("{R_BUTTON}DIFFICULTY");
static const u8 sText_TopBar_Challenges_Right[] = _("{R_BUTTON}CHALLENGES");
...
static void DrawTopBarText(void)
{
    ...
    switch (sOptions->submenu)
    {
        ...
        case MENU_DIFFICULTY:
            ...
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, right, 1, color, 0, sText_TopBar_Challenges_Right);
            break;
        case MENU_CHALLENGES:
            width = GetStringWidth(FONT_SMALL, sText_TopBar_Challenges, 0) / 2;
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 5, 1, color, 0, sText_TopBar_Difficulty_Left);
...
static bool8 TxRandomizerChallenges_LoadGraphics(void) // Load all the tilesets, tilemaps, spritesheets, and palettes
{
    switch (sOptions->gfxLoadState)
    {
    case 0:
        ResetTempTileDataBuffers();
        DecompressAndCopyTileDataToVram(2, sTxRandChalTiles, 0, 0, 0);
        sOptions->gfxLoadState++;
        break;
    case 1:
        if (FreeTempTileDataBuffersIfPossible() != TRUE)
        {
            LZDecompressWram(sTxRandChalTilemap, sBg2TilemapBuffer);
            sOptions->gfxLoadState++;
        }
        break;
    case 2:
    ...
    case 3:
        ...
        break;
    case 4:
        LoadPalette(sTxRandChalPalette, 64, 32);
...
void CB2_InitTxRandomizerChallengesMenu(void)
{
    ...
    case 2:
        ...
        break;
    case 3:
        if (TxRandomizerChallenges_LoadGraphics() == TRUE)
        {
            gMain.state++;
