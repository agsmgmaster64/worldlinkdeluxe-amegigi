...
static const struct GMaxMove sGMaxMoveTable[] =
{
    ...
    {SPECIES_PIKACHU_GMAX,                    TYPE_WIND,   MOVE_G_MAX_VOLT_CRASH},
    ...
    {SPECIES_TOXTRICITY_AMPED_GMAX,           TYPE_WIND,   MOVE_G_MAX_STUN_SHOCK},
    {SPECIES_TOXTRICITY_LOW_KEY_GMAX,         TYPE_WIND,   MOVE_G_MAX_STUN_SHOCK},
