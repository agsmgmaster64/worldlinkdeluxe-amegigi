...
{
    {SPECIES_VENUSAUR_GIGANTAMAX,                   TYPE_NATURE,     MOVE_G_MAX_VINE_LASH},
    {SPECIES_BLASTOISE_GIGANTAMAX,                  TYPE_WATER,      MOVE_G_MAX_CANNONADE},
    {SPECIES_CHARIZARD_GIGANTAMAX,                  TYPE_FIRE,       MOVE_G_MAX_WILDFIRE},
    {SPECIES_BUTTERFREE_GIGANTAMAX,                 TYPE_HEART,      MOVE_G_MAX_BEFUDDLE},
    {SPECIES_PIKACHU_GIGANTAMAX,                    TYPE_WIND,       MOVE_G_MAX_VOLT_CRASH},
    {SPECIES_MEOWTH_GIGANTAMAX,                     TYPE_ILLUSION,   MOVE_G_MAX_GOLD_RUSH},
    {SPECIES_MACHAMP_GIGANTAMAX,                    TYPE_DREAM,      MOVE_G_MAX_CHI_STRIKE},
    ...
    {SPECIES_EEVEE_GIGANTAMAX,                      TYPE_ILLUSION,   MOVE_G_MAX_CUDDLE},
    {SPECIES_SNORLAX_GIGANTAMAX,                    TYPE_ILLUSION,   MOVE_G_MAX_REPLENISH},
    {SPECIES_GARBODOR_GIGANTAMAX,                   TYPE_MIASMA,     MOVE_G_MAX_MALODOR},
    {SPECIES_MELMETAL_GIGANTAMAX,                   TYPE_STEEL,      MOVE_G_MAX_MELTDOWN},
    {SPECIES_RILLABOOM_GIGANTAMAX,                  TYPE_NATURE,     MOVE_G_MAX_DRUM_SOLO},
    ...
    {SPECIES_ORBEETLE_GIGANTAMAX,                   TYPE_REASON,     MOVE_G_MAX_GRAVITAS},
    {SPECIES_DREDNAW_GIGANTAMAX,                    TYPE_WATER,      MOVE_G_MAX_STONESURGE},
    {SPECIES_COALOSSAL_GIGANTAMAX,                  TYPE_BEAST,       MOVE_G_MAX_VOLCALITH},
    {SPECIES_FLAPPLE_GIGANTAMAX,                    TYPE_NATURE,      MOVE_G_MAX_TARTNESS},
    {SPECIES_APPLETUN_GIGANTAMAX,                   TYPE_NATURE,      MOVE_G_MAX_SWEETNESS},
    {SPECIES_SANDACONDA_GIGANTAMAX,                 TYPE_EARTH,     MOVE_G_MAX_SANDBLAST},
    {SPECIES_TOXTRICITY_AMPED_GIGANTAMAX,           TYPE_WIND,   MOVE_G_MAX_STUN_SHOCK},
    {SPECIES_TOXTRICITY_LOW_KEY_GIGANTAMAX,         TYPE_WIND,   MOVE_G_MAX_STUN_SHOCK},
    {SPECIES_CENTISKORCH_GIGANTAMAX,                TYPE_FIRE,       MOVE_G_MAX_CENTIFERNO},
    {SPECIES_HATTERENE_GIGANTAMAX,                  TYPE_COSMIC,     MOVE_G_MAX_SMITE},
    {SPECIES_GRIMMSNARL_GIGANTAMAX,                 TYPE_DARK,       MOVE_G_MAX_SNOOZE},
    {SPECIES_ALCREMIE_GIGANTAMAX,                   TYPE_COSMIC,     MOVE_G_MAX_FINALE},
    {SPECIES_COPPERAJAH_GIGANTAMAX,                 TYPE_STEEL,      MOVE_G_MAX_STEELSURGE},
    {SPECIES_DURALUDON_GIGANTAMAX,                  TYPE_FAITH,     MOVE_G_MAX_DEPLETION},
...
u8 GetMaxMovePower(u16 move)
{
    ...
    if (gBattleMoves[move].type == TYPE_DREAM
     || gBattleMoves[move].type == TYPE_MIASMA
