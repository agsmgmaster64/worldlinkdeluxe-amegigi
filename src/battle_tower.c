...
const u16 gBattleFrontierHeldItems[] =
{
    ...
    [BATTLE_FRONTIER_ITEM_SWIMSUIT]   = ITEM_SWIMSUIT,
    [BATTLE_FRONTIER_ITEM_STEWARDESS]     = ITEM_STEWARDESS,
    ...
    [BATTLE_FRONTIER_ITEM_NURSE_OUTFIT]    = ITEM_NURSE_OUTFIT,
    [BATTLE_FRONTIER_ITEM_THICK_FUR] = ITEM_THICK_FUR,
    [BATTLE_FRONTIER_ITEM_ASPEAR_BERRY]   = ITEM_ASPEAR_BERRY,
    [BATTLE_FRONTIER_ITEM_BURIAL_DRESS]      = ITEM_BURIAL_DRESS,
    ...
    [BATTLE_FRONTIER_ITEM_WITCHS_ROBE]  = ITEM_WITCHS_ROBE,
    [BATTLE_FRONTIER_ITEM_MAID_UNIFORM]     = ITEM_MAID_UNIFORM,
    [BATTLE_FRONTIER_ITEM_MENTAL_HERB]    = ITEM_MENTAL_HERB,
    [BATTLE_FRONTIER_ITEM_CHARCOAL]       = ITEM_GOTHIC_DRESS,
    [BATTLE_FRONTIER_ITEM_PECHA_BERRY]    = ITEM_PECHA_BERRY,
    [BATTLE_FRONTIER_ITEM_GYM_SUIT]      = ITEM_GYM_SUIT,
    [BATTLE_FRONTIER_ITEM_LUM_BERRY]      = ITEM_LUM_BERRY,
    [BATTLE_FRONTIER_ITEM_DRAGON_SCALE]   = ITEM_DRAGON_SCALE,
    [BATTLE_FRONTIER_ITEM_PRIESTESS]    = ITEM_PRIESTESS,
