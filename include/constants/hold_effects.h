...
enum ItemHoldEffect
{
    ...
    HOLD_EFFECT_EARTH_POWER,
    HOLD_EFFECT_BEAST_POWER,
    HOLD_EFFECT_NATURE_POWER,
    HOLD_EFFECT_DARK_POWER,
    HOLD_EFFECT_DREAM_POWER,
    HOLD_EFFECT_WIND_POWER,
    HOLD_EFFECT_WATER_POWER,
    HOLD_EFFECT_FLYING_POWER,
    HOLD_EFFECT_MIASMA_POWER,
    HOLD_EFFECT_ICE_POWER,
    HOLD_EFFECT_GHOST_POWER,
    HOLD_EFFECT_REASON_POWER,
    HOLD_EFFECT_FIRE_POWER,
    HOLD_EFFECT_FAITH_POWER,
    HOLD_EFFECT_ILLUSION_POWER,
    HOLD_EFFECT_UPGRADE,
