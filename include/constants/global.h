...
#define OPTIONS_MUSIC_STYLE_DEFAULT 0
#define OPTIONS_MUSIC_STYLE_ZGS 1
#define OPTIONS_MUSIC_STYLE_ALTERNATE 2
#define OPTIONS_MUSIC_STYLE_VANILLA 3
