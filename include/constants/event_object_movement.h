...
#define MOVEMENT_ACTION_RAISE_HAND_AND_STOP             0xAE
#define MOVEMENT_ACTION_RAISE_HAND_AND_JUMP             0xAF
#define MOVEMENT_ACTION_RAISE_HAND_AND_SWIM             0xB0
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      0xB1
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     0xB2
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    0xB3
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   0xB4
