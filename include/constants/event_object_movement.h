...
#define MOVEMENT_ACTION_RAISE_HAND_AND_STOP             0xB2
#define MOVEMENT_ACTION_RAISE_HAND_AND_JUMP             0xB3
#define MOVEMENT_ACTION_RAISE_HAND_AND_SWIM             0xB4
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      0xB5
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_RIGHT     0xB6
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_LEFT    0xB7
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_DOWN_RIGHT   0xB8
