...
#define STATUS3_PREDATOR_STALK          (1 << 15)
...
#define STATUS3_COMMANDER               (1 << 29)
#define STATUS3_POWER_TRICK             (1 << 30)
#define STATUS3_SKY_DROPPED             (1 << 31) // Target of Sky Drop
#define STATUS3_SEMI_INVULNERABLE_NO_COMMANDER  (STATUS3_UNDERGROUND | STATUS3_ON_AIR | STATUS3_UNDERWATER | STATUS3_PHANTOM_FORCE | STATUS3_PREDATOR_STALK) // Exception for Transform / Imposter
...
#define MOVE_RESULT_EXTREMELY_EFFECTIVE   (1 << 11)
#define MOVE_RESULT_MOSTLY_INEFFECTIVE    (1 << 12)
