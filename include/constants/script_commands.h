...
enum ScrOp
{
    ...
    SCR_OP_POKEVIAL = 0xE6,
    SCR_OP_PARTYCHECKFIELDMOVE = 0xE7,
    SCR_OP_SETSPEAKERNAME = 0xE8,
    SCR_OP_MOVETUTORMART = 0xE9,
    SCR_OP_POKEMARTOUTFIT = 0xEA,
    SCR_OP_ITEMSELLER = 0xEB,
    SCR_OP_QUESTMENU = 0xEC,
    SCR_OP_SUBQUESTMENU = 0xED,
    SCR_OP_RETURNQUESTSTATE = 0xEE,
    SCR_OP_TOGGLEOUTFIT = 0xEF,
    SCR_OP_GETOUTFITSTATUS = 0xF0,
    SCR_OP_BUFFEROUTFITSTR = 0xF1,
};
