...
#define SCR_OP_POKEVIAL 0xe6
#define SCR_OP_PARTYCHECKFIELDMOVE 0xe7
#define SCR_OP_SETSPEAKERNAME 0xe8
#define SCR_OP_MOVETUTORMART 0xe9
#define SCR_OP_POKEMARTOUTFIT 0xea
#define SCR_OP_ITEMSELLER 0xeb
#define SCR_OP_QUESTMENU 0xec
#define SCR_OP_SUBQUESTMENU 0xed
#define SCR_OP_RETURNQUESTSTATE 0xee
#define SCR_OP_TOGGLEOUTFIT 0xef
#define SCR_OP_GETOUTFITSTATUS 0xf0
#define SCR_OP_BUFFEROUTFITSTR 0xf1
=======
enum ScrOp
{
    SCR_OP_NOP = 0x0,
