...
#define OW_NAME_BOX_NPC_TRAINER       TRUE // When TRUE, any approaching NPC trainers will have a namebox shown automagically. The name would be taken from their trainer data.
