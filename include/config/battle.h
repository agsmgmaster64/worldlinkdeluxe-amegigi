...
#define B_VAR_DIFFICULTY            0     // If not 0, you can use this var to control whichsion of a Trainer is loaded. This should be manually set by the developer using Script_SetDifficulty AFTER NewGameInitData has run.
