...
#define B_VAR_STARTING_STATUS       VAR_BATTLE_TERRAIN     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN to it before battle causes the battle to start with that terrain active.
...
#define B_VAR_DIFFICULTY            VAR_UNUSED_0x40A8     // If not 0, you can use this var to control whichsion of a Trainer is loaded. This should be manually set by the developer using Script_SetDifficulty AFTER NewGameInitData has run.
