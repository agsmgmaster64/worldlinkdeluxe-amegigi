...
bool8 MetatileBehavior_IsFood(u8);
bool8 MetatileBehavior_IsVideoGame(u8);
bool8 MetatileBehavior_IsComputer(u8);
bool8 MetatileBehavior_IsImpressiveMachine(u8);
bool8 MetatileBehavior_IsCabinet(u8);
bool8 MetatileBehavior_IsKitchen(u8);
bool8 MetatileBehavior_IsDresser(u8);
bool8 MetatileBehavior_IsSnacks(u8);
bool8 MetatileBehavior_IsPainting(u8);
bool8 MetatileBehavior_IsPowerPlantMachine(u8);
bool8 MetatileBehavior_IsTelephone(u8);
bool8 MetatileBehavior_IsAdvertisingPoster(u8);
bool8 MetatileBehavior_IsTastyFood(u8);
bool8 MetatileBehavior_IsCup(u8);
bool8 MetatileBehavior_IsBlinkingLights(u8);
bool8 MetatileBehavior_IsNeatlyLinedUpTools(u8);
...
bool8 MetatileBehavior_IsFlipSwitchOn(u8);
bool8 MetatileBehavior_IsFlipSwitchOff(u8);
