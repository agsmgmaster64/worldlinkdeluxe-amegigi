...
extern const u32 gBallPal_Foul[];
...
extern const u32 gBallPal_PokeHisui[];
extern const u32 gBallGfx_GreatHisui[];
extern const u32 gBallPal_GreatHisui[];
extern const u32 gBallGfx_UltraHisui[];
extern const u32 gBallPal_UltraHisui[];
...
extern const u32 gItemIconPalette_PokeBallHisui[];
extern const u32 gItemIcon_GreatBallHisui[];
extern const u32 gItemIconPalette_GreatBallHisui[];
...
extern const u32 gItemIconPalette_GeyserWater[];
extern const u32 gItemIcon_BeerBottle[];
extern const u32 gItemIconPalette_BeerBottle[];
extern const u32 gItemIcon_UnagiLunch[];
extern const u32 gItemIconPalette_UnagiLunch[];
extern const u32 gItemIcon_SakeGourd[];
extern const u32 gItemIconPalette_SakeGourd[];
...
extern const u32 gItemIconPalette_HeavenPeach[];
...
extern const u32 gItemIconPalette_GreenUFO[];
extern const u32 gItemIconPalette_RedUFO[];
extern const u32 gItemIconPalette_BlueUFO[];
...
extern const u32 gItemIconPalette_PowerHeart[];
extern const u32 gItemIconPalette_GuardHeart[];
extern const u32 gItemIconPalette_SwiftHeart[];
extern const u32 gItemIconPalette_TechHeart[];
...
extern const u32 gItemIconPalette_IcyBall[];
extern const u32 gItemIcon_Bloomers[];
extern const u32 gItemIconPalette_Bloomers[];
extern const u32 gItemIcon_DarkRibbon[];
extern const u32 gItemIconPalette_DarkRibbon[];
extern const u32 gItemIcon_BigCloud[];
extern const u32 gItemIconPalette_BigCloud[];
...
extern const u32 gItemIconPalette_YataMirror[];
extern const u32 gItemIcon_Kusanagi[];
extern const u32 gItemIconPalette_Kusanagi[];
extern const u32 gItemIcon_DoubleSoul[];
extern const u32 gItemIconPalette_DoubleSoul[];
...
extern const u32 gItemIconPalette_BridalGown[];
extern const u32 gItemIcon_GothicDress[];
extern const u32 gItemIconPalette_GothicDress[];
extern const u32 gItemIcon_Swimsuit[];
extern const u32 gItemIconPalette_Swimsuit[];
extern const u32 gItemIcon_NinjaSuit[];
extern const u32 gItemIconPalette_NinjaSuit[];
extern const u32 gItemIcon_Camouflage[];
extern const u32 gItemIconPalette_Camouflage[];
extern const u32 gItemIcon_ThickFur[];
extern const u32 gItemIconPalette_ThickFur[];
extern const u32 gItemIcon_ChinaDress[];
extern const u32 gItemIconPalette_ChinaDress[];
extern const u32 gItemIcon_NurseOutfit[];
extern const u32 gItemIconPalette_NurseOutfit[];
extern const u32 gItemIcon_GymSuit[];
extern const u32 gItemIconPalette_GymSuit[];
extern const u32 gItemIcon_Stewardess[];
extern const u32 gItemIconPalette_Stewardess[];
extern const u32 gItemIcon_WitchsRobe[];
extern const u32 gItemIconPalette_WitchsRobe[];
extern const u32 gItemIcon_Blazer[];
extern const u32 gItemIconPalette_Blazer[];
extern const u32 gItemIcon_BunnySuit[];
extern const u32 gItemIconPalette_BunnySuit[];
extern const u32 gItemIcon_BurialDress[];
extern const u32 gItemIconPalette_BurialDress[];
extern const u32 gItemIcon_Priestess[];
extern const u32 gItemIconPalette_Priestess[];
...
extern const u32 gItemIconPalette_DonationBox[];
...
extern const u32 gItemIconPalette_PumkinBerry[];
extern const u32 gItemIcon_DrashBerry[];
extern const u32 gItemIconPalette_DrashBerry[];
extern const u32 gItemIcon_EggantBerry[];
extern const u32 gItemIconPalette_EggantBerry[];
extern const u32 gItemIcon_StribBerry[];
extern const u32 gItemIconPalette_StribBerry[];
extern const u32 gItemIcon_TurlanBerry[];
extern const u32 gItemIconPalette_TurlanBerry[];
extern const u32 gItemIcon_NutpeaBerry[];
extern const u32 gItemIconPalette_NutpeaBerry[];
extern const u32 gItemIcon_IonnoBerry[];
extern const u32 gItemIconPalette_IonnoBerry[];
extern const u32 gItemIcon_KuoBerry[];
extern const u32 gItemIconPalette_KuoBerry[];
extern const u32 gItemIcon_YagoBerry[];
extern const u32 gItemIconPalette_YagoBerry[];
extern const u32 gItemIcon_TougaBerry[];
extern const u32 gItemIconPalette_TougaBerry[];
extern const u32 gItemIcon_GarligBerry[];
extern const u32 gItemIconPalette_GarligBerry[];
extern const u32 gItemIcon_TopoBerry[];
extern const u32 gItemIconPalette_TopoBerry[];
// TMs/HMs
...
extern const u32 gItemIconPalette_IllusionTMHM[];
extern const u32 gItemIconPalette_WindTMHM[];
extern const u32 gItemIconPalette_NatureTMHM[];
extern const u32 gItemIconPalette_DreamTMHM[];
extern const u32 gItemIconPalette_MiasmaTMHM[];
extern const u32 gItemIconPalette_EarthTMHM[];
extern const u32 gItemIconPalette_ReasonTMHM[];
