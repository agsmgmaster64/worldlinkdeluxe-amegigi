...
extern const u8 Move_SEAL_NEEDLE[];
...
extern const u8 Move_POISON_TEARS[];
...
extern const u8 Move_PSYSHOT[];
extern const u8 Move_MANA_BURST[];
...
extern const u8 Move_MANA_SHIELD[];
...
extern const u8 Move_TOXIC_GAS[];
...
extern const u8 Move_HEAT_CLAW[];
...
extern const u8 Move_POISON_BOMB[];
extern const u8 Move_MUD_SLAP[];
extern const u8 Move_BLACK_RIPPLE[];
...
extern const u8 Move_BATTLE_CHANT[];
extern const u8 Move_DECISION[];
...
extern const u8 Move_STEEL_FIST[];
...
extern const u8 Move_MULTI_PULSE[];
...
extern const u8 Move_PERFORMANCE[];
extern const u8 Move_COERCE[];
extern const u8 Move_BRAVER[];
extern const u8 Move_SHADOW_DANCE[];
...
extern const u8 Move_GUARD[];
extern const u8 Move_NATIVE_POWER[];
...
extern const u8 Move_MANA_CHARGE[];
...
extern const u8 Move_BINDING_VOICE[];
extern const u8 Move_NATURE_SOUND[];
...
extern const u8 Move_HEART_BREAK[];
...
extern const u8 Move_MYSTIC_WATER[];
...
extern const u8 Move_ENERGY_LIGHT[];
...
extern const u8 Move_BLADE_FLASH[];
extern const u8 Move_AVALANCHE[];
extern const u8 Move_ICE_SHARD[];
extern const u8 Move_SHADOW_HIT[];
...
extern const u8 Move_DRAWN_LINE[];
...
extern const u8 Move_HOLY_TERRAIN[];
...
extern const u8 Move_ROCK_BULLET[];
